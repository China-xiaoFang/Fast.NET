...
- Restored Simplified Chinese diagnostics in `UploadNuget.bat` by removing forced English output and scoping the CLI language to the script. Publication classification now recognizes both Chinese and English diagnostics without changing result colors, package lists, or exit codes.
