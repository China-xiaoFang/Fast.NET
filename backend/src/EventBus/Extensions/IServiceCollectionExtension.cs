...
public static class IServiceCollectionExtension
{
    ...
    public static IServiceCollection AddEventBus(this IServiceCollection services)
    {
        ...
        var iEventHandlerMonitorType =
            IaaSContext.EffectiveTypes.FirstOrDefault(f => typeof(IEventHandlerMonitor).IsAssignableFrom(f) && !f.IsInterface);
        ...
        var iEventFallbackPolicyType =
            IaaSContext.EffectiveTypes.FirstOrDefault(f => typeof(IEventFallbackPolicy).IsAssignableFrom(f) && !f.IsInterface);
