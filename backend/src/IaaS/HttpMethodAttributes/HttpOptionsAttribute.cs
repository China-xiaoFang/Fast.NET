...
/// <summary>
/// Fast.NET 下的 <see cref="HttpOptionsAttribute"/> Identifies an action that supports the HTTP OPTIONS method.
/// </summary>
...
public class HttpOptionsAttribute : HttpMethodAttribute
{
    ...
    public HttpOptionsAttribute(string template, params string[] tags) : base(_supportedMethods, template)
    {
        if (template == null)
        {
