...
/// <summary>
/// Fast.NET 下的 <see cref="HttpPutAttribute"/> Identifies an action that supports the HTTP PUT method.
/// </summary>
...
public class HttpPutAttribute : HttpMethodAttribute
{
    ...
    public HttpPutAttribute(string template, params string[] tags) : base(_supportedMethods, template)
    {
        if (template == null)
        {
