...
/// <summary>
/// Fast.NET 下的 <see cref="HttpGetAttribute"/> Identifies an action that supports the HTTP GET method.
/// </summary>
...
public class HttpGetAttribute : HttpMethodAttribute
{
    ...
    public HttpGetAttribute(string template, params string[] tags) : base(_supportedMethods, template)
    {
        if (template == null)
        {
