...
public static class IServiceCollectionExtension
{
    ...
    public static IServiceCollection AddDependencyInjection(this IServiceCollection services)
    {
        ...
        // 获取程序集需要依赖注入的类型
        var injectTypes = IaaSContext.Assemblies.SelectMany(sl => sl.GetAssemblyTypes(
            wh => IDependencyType.IsAssignableFrom(wh) && wh.IsClass && !wh.IsInterface && !wh.IsAbstract));
        ...
        foreach (var type in injectTypes)
        {
            ...
            var canInjectInterfaces = interfaces.Where(u =>
                ...
                !lifetimeInterfaces.Contains(u) && IaaSContext.Assemblies.Contains(u.Assembly) &&
