...
internal sealed class DataValidationFilter : IAsyncActionFilter, IOrderedFilter
{
    ...
    private async Task<bool> HandleValidation(ActionExecutingContext context, MethodInfo method,
        ControllerActionDescriptor actionDescriptor, object errors, ActionExecutedContext resultContext = default,
        UserFriendlyException userFriendlyException = default)
    {
