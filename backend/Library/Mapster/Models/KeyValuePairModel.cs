...
public class KeyValuePairModel : IMemberModelEx
{
    ...
    public KeyValuePairModel(string name, Type type, Func<Expression, Expression, Expression> getFn,
    ...
    public IEnumerable<CustomAttributeData> GetCustomAttributesData() => Enumerable.Empty<CustomAttributeData>();
