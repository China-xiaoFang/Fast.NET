...
public class MapContextScope : IDisposable
{
    ...
    public MapContextScope(bool ignorePreviousContext)
    {
        ...
        Context = ignorePreviousContext ? new MapContext() : _previousContext ?? new MapContext();
    ...
    public static TResult GetOrAddMapReference<TResult>(ReferenceTuple key, Func<ReferenceTuple, TResult> mapFn)
