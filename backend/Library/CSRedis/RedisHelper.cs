...
public abstract partial class RedisHelper<TMark>
{
    ...
    public static int RandomExpired(int minTimeoutSeconds, int maxTimeoutSeconds) =>
        rnd.Value.Next(minTimeoutSeconds, maxTimeoutSeconds);
    ...
    public static CSRedisClient Instance
    {
        get
        {
            if (_instance == null)
                throw new Exception(
                    "使用前请初始化 RedisHelper.Initialization(new CSRedis.CSRedisClient(\"127.0.0.1:6379,password=123,defaultDatabase=13,poolsize=50,ssl=false,writeBuffer=10240,prefix=key前辍\"));");
            return _instance;
        }
    }
    ...
    public static T CacheShell<T>(string key, int timeoutSeconds, Func<T> getData) =>
        Instance.CacheShell(key, timeoutSeconds, getData);
    ...
    public static T CacheShell<T>(string key, string field, int timeoutSeconds, Func<T> getData) =>
        Instance.CacheShell(key, field, timeoutSeconds, getData);
    ...
    /// <returns></returns>
    public static (string key, T value)[] CacheShell<T>(string key, string[] fields, int timeoutSeconds,
        Func<string[], (string, T)[]> getData) =>
        Instance.CacheShell(key, fields, timeoutSeconds, getData);
    ...
    public static CSRedisClient.SubscribeObject Subscribe(
        params (string, Action<CSRedisClient.SubscribeMessageEventArgs>)[] channels) =>
    ...
    public static CSRedisClient.PSubscribeObject PSubscribe(string[] channelPatterns,
        Action<CSRedisClient.PSubscribePMessageEventArgs> pmessage) =>
        Instance.PSubscribe(channelPatterns, pmessage);
    ...
    /// <returns></returns>
    public static CSRedisClient.SubscribeListBroadcastObject SubscribeListBroadcast(string listKey, string clientId,
        Action<string> onMessage) =>
        Instance.SubscribeListBroadcast(listKey, clientId, onMessage);
    ...
    /// <param name="onMessage">接收消息委托</param>
    /// <returns></returns>
    public static CSRedisClient.SubscribeListObject SubscribeList(string listKey, Action<string> onMessage) =>
        Instance.SubscribeList(listKey, onMessage);
    ...
    /// <returns></returns>
    public static CSRedisClient.SubscribeListObject SubscribeList(string[] listKeys, Action<string, string> onMessage) =>
        Instance.SubscribeList(listKeys, onMessage);
    ...
    public static long ZInterStore(string destination, decimal[] weights, RedisAggregate aggregate, params string[] keys) =>
        Instance.ZInterStore(destination, weights, aggregate, keys);
    ...
    public static (string member, decimal score)[] ZRangeWithScores(string key, long start, long stop) =>
        Instance.ZRangeWithScores(key, start, stop);
    ...
    public static (T member, decimal score)[] ZRangeWithScores<T>(string key, long start, long stop) =>
        Instance.ZRangeWithScores<T>(key, start, stop);
    ...
    /// <param name="offset">返回条件偏移位置</param>
    /// <returns></returns>
    public static (string member, decimal score)[] ZRangeByScoreWithScores(string key, decimal min, decimal max,
    ...
    /// <param name="offset">返回条件偏移位置</param>
    /// <returns></returns>
    public static (T member, decimal score)[] ZRangeByScoreWithScores<T>(string key, decimal min, decimal max, long? limit = null,
        long offset = 0) =>
    ...
    /// <param name="offset">返回条件偏移位置</param>
    /// <returns></returns>
    public static (string member, decimal score)[] ZRangeByScoreWithScores(string key, string min, string max, long? limit = null,
        long offset = 0) =>
        Instance.ZRangeByScoreWithScores(key, min, max, limit, offset);
    ...
    /// <param name="offset">返回条件偏移位置</param>
    /// <returns></returns>
    public static (T member, decimal score)[] ZRangeByScoreWithScores<T>(string key, string min, string max, long? limit = null,
        long offset = 0) =>
        Instance.ZRangeByScoreWithScores<T>(key, min, max, limit, offset);
    ...
    public static (string member, decimal score)[] ZRevRangeWithScores(string key, long start, long stop) =>
        Instance.ZRevRangeWithScores(key, start, stop);
    ...
    public static (T member, decimal score)[] ZRevRangeWithScores<T>(string key, long start, long stop) =>
        Instance.ZRevRangeWithScores<T>(key, start, stop);
    ...
    public static string[] ZRevRangeByScore(string key, decimal max, decimal min, long? limit = null, long? offset = 0) =>
        Instance.ZRevRangeByScore(key, max, min, limit, offset);
    ...
    /// <param name="offset">返回条件偏移位置</param>
    /// <returns></returns>
    public static (string member, decimal score)[] ZRevRangeByScoreWithScores(string key, decimal max, decimal min,
        long? limit = null, long offset = 0) =>
    ...
    /// <param name="offset">返回条件偏移位置</param>
    /// <returns></returns>
    public static (T member, decimal score)[] ZRevRangeByScoreWithScores<T>(string key, decimal max, decimal min,
        long? limit = null, long offset = 0) =>
    ...
    /// <param name="offset">返回条件偏移位置</param>
    /// <returns></returns>
    public static (string member, decimal score)[] ZRevRangeByScoreWithScores(string key, string max, string min,
        long? limit = null, long offset = 0) =>
        Instance.ZRevRangeByScoreWithScores(key, max, min, limit, offset);
    ...
    /// <param name="offset">返回条件偏移位置</param>
    /// <returns></returns>
    public static (T member, decimal score)[] ZRevRangeByScoreWithScores<T>(string key, string max, string min,
        long? limit = null, long offset = 0) =>
        Instance.ZRevRangeByScoreWithScores<T>(key, max, min, limit, offset);
    ...
    public static long ZUnionStore(string destination, decimal[] weights, RedisAggregate aggregate, params string[] keys) =>
        Instance.ZUnionStore(destination, weights, aggregate, keys);
    ...
    /// <returns></returns>
    public static RedisScan<(string member, decimal score)> ZScan(string key, long cursor, string pattern = null,
        long? count = null) =>
    ...
    /// <param name="count">数量</param>
    /// <returns></returns>
    public static RedisScan<(T member, decimal score)> ZScan<T>(string key, long cursor, string pattern = null,
        long? count = null) =>
    ...
    /// <param name="max">'(' 表示包含在范围，'[' 表示不包含在范围，'+' 正无穷大，'-' 负无限。 ZRANGEBYLEX zset - + ，命令将返回有序集合中的所有元素</param>
    /// <returns></returns>
    public static long ZRemRangeByLex(string key, string min, string max) => Instance.ZRemRangeByLex(key, min, max);
    ...
    /// <param name="max">'(' 表示包含在范围，'[' 表示不包含在范围，'+' 正无穷大，'-' 负无限。 ZRANGEBYLEX zset - + ，命令将返回有序集合中的所有元素</param>
    /// <returns></returns>
    public static long ZLexCount(string key, string min, string max) => Instance.ZLexCount(key, min, max);
    ...
    /// <param name="count">数量</param>
    /// <returns></returns>
    public static (string member, decimal score)[] ZPopMax(string key, long count) => Instance.ZPopMax(key, count);
    ...
    /// <param name="count">数量</param>
    /// <returns></returns>
    public static (T member, decimal score)[] ZPopMax<T>(string key, long count) => Instance.ZPopMax<T>(key, count);
    ...
    /// <param name="count">数量</param>
    /// <returns></returns>
    public static (string member, decimal score)[] ZPopMin(string key, long count) => Instance.ZPopMin(key, count);
    ...
    /// <param name="count">数量</param>
    /// <returns></returns>
    public static (T member, decimal score)[] ZPopMin<T>(string key, long count) => Instance.ZPopMin<T>(key, count);
    ...
    /// <returns></returns>
    public static (string key, string value)? BLPopWithKey(int timeout, params string[] keys) =>
        Instance.BLPopWithKey(timeout, keys);
    ...
    /// <param name="keys">一个或多个列表，不含prefix前辍</param>
    /// <returns></returns>
    public static (string key, T value)? BLPopWithKey<T>(int timeout, params string[] keys) =>
        Instance.BLPopWithKey<T>(timeout, keys);
    ...
    /// <param name="keys">一个或多个列表，不含prefix前辍</param>
    /// <returns></returns>
    public static (string key, string value)? BRPopWithKey(int timeout, params string[] keys) =>
        Instance.BRPopWithKey(timeout, keys);
    ...
    /// <param name="keys">一个或多个列表，不含prefix前辍</param>
    /// <returns></returns>
    public static (string key, T value)? BRPopWithKey<T>(int timeout, params string[] keys) =>
        Instance.BRPopWithKey<T>(timeout, keys);
    ...
    public static string BRPopLPush(string source, string destination, int timeout) =>
        Instance.BRPopLPush(source, destination, timeout);
    ...
    /// <param name="timeout">超时(秒)</param>
    /// <returns></returns>
    public static T BRPopLPush<T>(string source, string destination, int timeout) =>
        Instance.BRPopLPush<T>(source, destination, timeout);
    ...
    /// <param name="count">数量</param>
    /// <returns></returns>
    public static RedisScan<(string field, string value)> HScan(string key, long cursor, string pattern = null,
        long? count = null) =>
    ...
    /// <param name="count">数量</param>
    /// <returns></returns>
    public static RedisScan<(string field, T value)>
        HScan<T>(string key, long cursor, string pattern = null, long? count = null) =>
    ...
    public static long BitPos(string key, bool bit, long? start = null, long? end = null) =>
        Instance.BitPos(key, bit, start, end);
    ...
    public static bool Set(string key, object value, TimeSpan expire, RedisExistence? exists = null) =>
        Instance.Set(key, value, expire, exists);
    ...
    public static bool Restore(string key, long ttlMilliseconds, byte[] serializedValue) =>
        Instance.Restore(key, ttlMilliseconds, serializedValue);
    ...
    /// <returns></returns>
    public static string[] Sort(string key, long? count = null, long offset = 0, string by = null, RedisSortDir? dir = null,
    ...
    /// <param name="get">根据排序的结果来取出相应的键值</param>
    /// <returns></returns>
    public static long SortAndStore(string key, string destination, long? count = null, long offset = 0, string by = null,
    ...
    /// <param name="count">数量</param>
    /// <returns></returns>
    public static RedisScan<string> Scan(long cursor, string pattern = null, long? count = null) =>
        Instance.Scan(cursor, pattern, count);
    ...
    /// <param name="count">数量</param>
    /// <returns></returns>
    public static RedisScan<T> Scan<T>(string key, long cursor, string pattern = null, long? count = null) =>
        Instance.Scan<T>(cursor, pattern, count);
    ...
    public static bool GeoAdd(string key, decimal longitude, decimal latitude, object member) =>
        Instance.GeoAdd(key, longitude, latitude, member);
    ...
    public static decimal? GeoDist(string key, object member1, object member2, GeoUnit unit = GeoUnit.m) =>
        Instance.GeoDist(key, member1, member2, unit);
    ...
    /// <returns></returns>
    public static string[] GeoRadius(string key, decimal longitude, decimal latitude, decimal radius, GeoUnit unit = GeoUnit.m,
    ...
    /// <param name="sorting">排序</param>
    /// <returns></returns>
    public static T[] GeoRadius<T>(string key, decimal longitude, decimal latitude, decimal radius, GeoUnit unit = GeoUnit.m,
        long? count = null, GeoOrderBy? sorting = null) =>
    ...
    /// <param name="sorting">排序</param>
    /// <returns></returns>
    public static (string member, decimal dist)[] GeoRadiusWithDist(string key, decimal longitude, decimal latitude,
    ...
    /// <param name="sorting">排序</param>
    /// <returns></returns>
    public static (T member, decimal dist)[] GeoRadiusWithDist<T>(string key, decimal longitude, decimal latitude, decimal radius,
    ...
    /// <param name="sorting">排序</param>
    /// <returns></returns>
    public static (string member, decimal dist, decimal longitude, decimal latitude)[] GeoRadiusWithDistAndCoord(string key,
    ...
    /// <param name="sorting">排序</param>
    /// <returns></returns>
    public static (T member, decimal dist, decimal longitude, decimal latitude)[] GeoRadiusWithDistAndCoord<T>(string key,
        decimal longitude, decimal latitude, decimal radius, GeoUnit unit = GeoUnit.m, long? count = null,
        GeoOrderBy? sorting = null) =>
    ...
    /// <param name="sorting">排序</param>
    /// <returns></returns>
    public static string[] GeoRadiusByMember(string key, object member, decimal radius, GeoUnit unit = GeoUnit.m,
        long? count = null, GeoOrderBy? sorting = null) =>
    ...
    /// <param name="sorting">排序</param>
    /// <returns></returns>
    public static T[] GeoRadiusByMember<T>(string key, object member, decimal radius, GeoUnit unit = GeoUnit.m,
        long? count = null, GeoOrderBy? sorting = null) =>
    ...
    /// <param name="sorting">排序</param>
    /// <returns></returns>
    public static (string member, decimal dist)[] GeoRadiusByMemberWithDist(string key, object member, decimal radius,
        GeoUnit unit = GeoUnit.m, long? count = null, GeoOrderBy? sorting = null) =>
    ...
    /// <param name="sorting">排序</param>
    /// <returns></returns>
    public static (T member, decimal dist)[] GeoRadiusByMemberWithDist<T>(string key, object member, decimal radius,
        GeoUnit unit = GeoUnit.m, long? count = null, GeoOrderBy? sorting = null) =>
    ...
    /// <param name="sorting">排序</param>
    /// <returns></returns>
    public static (string member, decimal dist, decimal longitude, decimal latitude)[] GeoRadiusByMemberWithDistAndCoord(
    ...
    /// <param name="sorting">排序</param>
    /// <returns></returns>
    public static (T member, decimal dist, decimal longitude, decimal latitude)[] GeoRadiusByMemberWithDistAndCoord<T>(string key,
    ...
    /// <returns></returns>
    public static CSRedisClientLock Lock(string name, int timeoutSeconds, bool autoDelay = true) =>
        Instance.Lock(name, timeoutSeconds);
}