...
class RedisConnector
{
    ...
    public int ReceiveTimeout
    {
        get
        {
            return _redisSocket.ReceiveTimeout;
        }
        set
        {
            _redisSocket.ReceiveTimeout = value;
        }
    }
    ...
    public int SendTimeout
    {
        get
        {
            return _redisSocket.SendTimeout;
        }
        set
        {
            _redisSocket.SendTimeout = value;
        }
    }
    ...
    {
        return _redisSocket.ConnectAsync(EndPoint);
    }
#endif
