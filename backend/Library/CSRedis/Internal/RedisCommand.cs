...
static class RedisCommands
{
    ...
    {
        var args = RedisArgs.Concat("ENCODING", arguments);
    ...
    {
        var args = RedisArgs.Concat(subCommand.ToString().ToUpperInvariant(), arguments);
    ...
    public static RedisArray.Generic<Dictionary<string, string>> Sort(string key, long? offset = null, long? count = null,
        string by = null, RedisSortDir? dir = null, bool? isAlpha = null, bool? isHash = null, params string[] get)
    {
    ...
    public static RedisArray.Strings Sort(string key, long? offset = null, long? count = null, string by = null,
    ...
    public static RedisInt SortAndStore(string key, string destination, long? offset = null, long? count = null, string by = null,
        RedisSortDir? dir = null, bool? isAlpha = null, params string[] get)
    {
        var args = new List<string>();
        args.Add(key);
    ...
    public static RedisScanCommand<byte[]> ScanBytes(long cursor, string pattern = null, long? count = null)
    {
        ...
        if (count != null)
            args.AddRange(new object[] {"COUNT", count});
        return new RedisScanCommand<byte[]>(new RedisArray.Bytes("SCAN", args.ToArray()));
    }
    ...
    public static RedisHash.Generic<T> HGetAll<T>(string key) where T : class
    {
    ...
    public static RedisScanCommand<Tuple<string, string>> HScan(string key, long cursor, string pattern = null,
        long? count = null)
    {
        var args = new List<object>();
        args.Add(key);
    ...
    public static RedisScanCommand<Tuple<string, byte[]>> HScanBytes(string key, long cursor, string pattern = null,
        long? count = null)
    {
        var args = new List<object>();
        args.Add(key);
    ...
    {
        var args = RedisArgs.Concat(keys, new object[] {timeout});
    ...
    {
        var args = RedisArgs.Concat(new[] {key}, values);
    ...
    {
        var args = RedisArgs.Concat(key, values);
    ...
    {
        var args = RedisArgs.Concat(key, members);
    ...
    {
        var args = RedisArgs.Concat(destination, keys);
    ...
    public static RedisScanCommand<byte[]> SScanBytes(string key, long cursor, string pattern = null, long? count = null)
    {
        ...
        if (count != null)
            args.AddRange(new object[] {"COUNT", count});
        return new RedisScanCommand<byte[]>(new RedisArray.Bytes("SSCAN", args.ToArray()));
    }
    ...
    {
        var args = RedisArgs.Concat(key, RedisArgs.GetTupleArgs(scoreMembers));
        return new RedisInt("ZADD", args);
    }

    public static RedisInt ZAdd(string key, params object[] scoreMembers)
    {
        var args = RedisArgs.Concat(key, scoreMembers);
        return new RedisInt("ZADD", args);
    }
    ...
    {
        var min_score = RedisArgs.GetScore(min, exclusiveMin);
        var max_score = RedisArgs.GetScore(max, exclusiveMax);
    ...
    public static RedisInt ZInterStore(string destination, decimal[] weights = null, RedisAggregate? aggregate = null,
        params string[] keys)
    {
        var args = new List<object>();
    ...
    {
        return new RedisArray.StrongPairs<byte[], decimal>(new RedisBytes(null), new RedisFloat(null), "ZRANGE", key, start, stop,
            "WITHSCORES");
    }

    public static RedisArray.Strings ZRangeByScore(string key, decimal min, decimal max, bool withScores = false,
    ...
    public static RedisArray.Bytes ZRangeBytesByScore(string key, decimal min, decimal max, bool withScores = false,
        bool exclusiveMin = false, bool exclusiveMax = false, long? offset = null, long? count = null)
    {
        var min_score = RedisArgs.GetScore(min, exclusiveMin);
        var max_score = RedisArgs.GetScore(max, exclusiveMax);
    ...
    public static RedisArray.WeakPairs<string, decimal> ZRangeByScoreWithScores(string key, decimal min, decimal max,
        bool exclusiveMin = false, bool exclusiveMax = false, long? offset = null, long? count = null)
    {
        var min_score = RedisArgs.GetScore(min, exclusiveMin);
        var max_score = RedisArgs.GetScore(max, exclusiveMax);
    ...
    public static RedisArray.StrongPairs<byte[], decimal> ZRangeBytesByScoreWithScores(string key, decimal min, decimal max,
        bool exclusiveMin = false, bool exclusiveMax = false, long? offset = null, long? count = null)
    {
        var min_score = RedisArgs.GetScore(min, exclusiveMin);
        var max_score = RedisArgs.GetScore(max, exclusiveMax);
    ...
    public static RedisArray.Strings ZRangeByScore(string key, string min, string max, bool withScores = false,
        long? offset = null, long? count = null)
    {
        object[] args = {key, min, max};
        if (withScores)
    ...
    public static RedisArray.Bytes ZRangeBytesByScore(string key, string min, string max, bool withScores = false,
        long? offset = null, long? count = null)
    {
        object[] args = {key, min, max};
        if (withScores)
    ...
    public static RedisArray.WeakPairs<string, decimal> ZRangeByScoreWithScores(string key, string min, string max,
        long? offset = null, long? count = null)
    {
        object[] args = {key, min, max, "WITHSCORES"};
        if (offset.HasValue && count.HasValue)
            args = RedisArgs.Concat(args, new[] {"LIMIT", offset.Value.ToString(), count.Value.ToString()});
    ...
    public static RedisArray.StrongPairs<byte[], decimal> ZRangeBytesByScoreWithScores(string key, string min, string max,
        long? offset = null, long? count = null)
    {
        object[] args = {key, min, max, "WITHSCORES"};
        if (offset.HasValue && count.HasValue)
    ...
    {
        var args = RedisArgs.Concat(new[] {key}, members);
    ...
    public static RedisInt ZRemRangeByScore(string key, decimal min, decimal max, bool exclusiveMin = false,
    ...
    {
        return new RedisArray.StrongPairs<byte[], decimal>(new RedisBytes(null), new RedisFloat(null), "ZREVRANGE", key,
            start.ToString(), stop.ToString(), "WITHSCORES");
    }

    public static RedisArray.Strings ZRevRangeByScore(string key, decimal max, decimal min, bool withScores = false,
    ...
    public static RedisArray.Bytes ZRevRangeBytesByScore(string key, decimal max, decimal min, bool withScores = false,
        bool exclusiveMax = false, bool exclusiveMin = false, long? offset = null, long? count = null)
    {
        var min_score = RedisArgs.GetScore(min, exclusiveMin);
        var max_score = RedisArgs.GetScore(max, exclusiveMax);
    ...
    public static RedisArray.Strings ZRevRangeByScore(string key, string max, string min, bool withScores = false,
        long? offset = null, long? count = null)
    {
        object[] args = {key, max, min};
        if (withScores)
            args = RedisArgs.Concat(args, new[] {"WITHSCORES"});
        if (count.HasValue)
    ...
    public static RedisArray.Bytes ZRevRangeBytesByScore(string key, string max, string min, bool withScores = false,
        long? offset = null, long? count = null)
    {
        object[] args = {key, max, min};
        if (withScores)
    ...
    public static RedisArray.WeakPairs<string, decimal> ZRevRangeByScoreWithScores(string key, decimal max, decimal min,
        bool exclusiveMax = false, bool exclusiveMin = false, long? offset = null, long? count = null)
    {
        var min_score = RedisArgs.GetScore(min, exclusiveMin);
        var max_score = RedisArgs.GetScore(max, exclusiveMax);
    ...
    public static RedisArray.StrongPairs<byte[], decimal> ZRevRangeBytesByScoreWithScores(string key, decimal max, decimal min,
        bool exclusiveMax = false, bool exclusiveMin = false, long? offset = null, long? count = null)
    {
        var min_score = RedisArgs.GetScore(min, exclusiveMin);
        var max_score = RedisArgs.GetScore(max, exclusiveMax);
    ...
    public static RedisArray.WeakPairs<string, decimal> ZRevRangeByScoreWithScores(string key, string max, string min,
        long? offset = null, long? count = null)
    {
        object[] args = {key, max, min, "WITHSCORES"};
        if (count.HasValue)
            args = RedisArgs.Concat(args, new[] {"LIMIT", (offset ?? 0).ToString(), count.Value.ToString()});
    ...
    public static RedisArray.StrongPairs<byte[], decimal> ZRevRangeBytesByScoreWithScores(string key, string max, string min,
        long? offset = null, long? count = null)
    {
        object[] args = {key, max, min, "WITHSCORES"};
        if (count.HasValue)
    ...
    public static RedisInt ZUnionStore(string destination, decimal[] weights = null, RedisAggregate? aggregate = null,
        params string[] keys)
    {
        var args = new List<object>();
        args.Add(destination);
    ...
    public static RedisScanCommand<Tuple<string, decimal>> ZScan(string key, long cursor, string pattern = null,
        long? count = null)
    {
        var args = new List<object>();
        args.Add(key);
        ...
        if (count != null)
            args.AddRange(new object[] {"COUNT", count});
        return new RedisScanCommand<Tuple<string, decimal>>(new RedisArray.WeakPairs<string, decimal>("ZSCAN", args.ToArray()));
        //<Tuple<string, decimal>>(
        //new RedisTuple.Generic<string, decimal>.Bulk("ZSCAN", args.ToArray())));
    }

    public static RedisScanCommand<Tuple<byte[], decimal>> ZScanBytes(string key, long cursor, string pattern = null,
        long? count = null)
    {
        var args = new List<object>();
        args.Add(key);
        ...
        return new RedisScanCommand<Tuple<byte[], decimal>>(
            new RedisArray.StrongPairs<byte[], decimal>(new RedisBytes(null), new RedisFloat(null), "ZSCAN", args.ToArray()));
        //<Tuple<string, decimal>>(
        //new RedisTuple.Generic<string, decimal>.Bulk("ZSCAN", args.ToArray())));
    }
    ...
    {
        var args = RedisArgs.Concat("NUMSUB", channels);
        return new RedisArray.StrongPairs<string, long>(new RedisString(null), new RedisInt(null), "PUBSUB", args);
    }
    ...
    {
        var args = RedisArgs.Concat(new object[] {script, keys.Length}, keys, arguments);
    ...
    {
        var args = RedisArgs.Concat(new object[] {sha1, keys.Length}, keys, arguments);
    ...
    {
        var args = start.HasValue && end.HasValue ? new[] {key, start.Value.ToString(), end.Value.ToString()} : new[] {key};
        return new RedisInt("BITCOUNT", args);
    }

    public static RedisInt BitOp(RedisBitOp operation, string destKey, params string[] keys)
    {
        var args = RedisArgs.Concat(new[] {operation.ToString().ToUpperInvariant(), destKey}, keys);
    ...
    {
        var args = RedisArgs.GetTupleArgs(keyValues);
    ...
    public static RedisStatus.Nullable Set(string key, object value, int? expirationSeconds = null,
        RedisExistence? condition = null)
    {
        return Set(key, value, expirationSeconds, null, condition);
    }

    public static RedisStatus.Nullable Set(string key, object value, long? expirationMilliseconds = null,
        RedisExistence? condition = null)
    {
        return Set(key, value, null, expirationMilliseconds, condition);
    }

    private static RedisStatus.Nullable Set(string key, object value, int? expirationSeconds = null,
        long? expirationMilliseconds = null, RedisExistence? exists = null)
    {
    ...
    public static RedisArray.Generic<RedisSlowLogEntry> SlowLogGet(long? count = null)
    {
        ...
        return new RedisArray.Generic<RedisSlowLogEntry>(new RedisSlowLogCommand("SLOWLOG", args.ToArray()));
    }
    ...
    {
        var args = RedisArgs.Concat(key, elements);
    ...
    {
        var args = RedisArgs.Concat(destKey, sourceKeys);
    ...
    public static RedisString XAdd(string key, long maxLen, string id = "*", params (string, string)[] fieldValues)
    {
        ...
        args.Add(key);
        if (maxLen > 0)
            args.AddRange(new object[] {"MAXLEN", maxLen});
        else if (maxLen < 0)
            args.AddRange(new object[] {"MAXLEN", "~", Math.Abs(maxLen)});
        args.Add(id);
    ...
    public static RedisXRangeCommand XClaim(string key, string group, string consumer, long minIdleTime, string[] id, long idle,
    ...
    public static RedisArray.Strings XClaimJustId(string key, string group, string consumer, long minIdleTime, string[] id,
    ...
    {
        var args = RedisArgs.Concat(key, id);
    ...
    public static RedisXPendingStartEndCountCommand XPending(string key, string group, string start, string end, long count,
    ...
    public static RedisXRangeCommand XRange(string key, string start, string end, long count = 1)
    {
        ...
        if (count > 0)
            args.AddRange(new[] {"COUNT", count.ToString()});
    ...
    public static RedisXReadCommand XRead(long count, long block, params (string key, string id)[] streams)
    {
        ...
        if (count > 0)
            args.AddRange(new[] {"COUNT", count.ToString()});
        if (block > 0)
            args.AddRange(new[] {"BLOCK", block.ToString()});
        args.Add("STREAMS");
    ...
    public static RedisXReadCommand XReadGroup(string group, string consumer, long count, long block,
    ...
    {
        if (maxLen > 0)
            return new RedisInt("XTRIM", key, "MAXLEN", maxLen.ToString());
    ...
    public static RedisStatus BfReserve(string key, decimal errorRate, long capacity, int expansion = 2, bool nonScaling = false)
    {
        ...
        if (expansion != 2)
            args.AddRange(new object[] {"EXPANSION", expansion});
        if (nonScaling)
            args.Add("NONSCALING");
    ...
    public static RedisArray.Generic<bool> BfInsert(string key, object[] items, long? capacity = null, string error = null,
        int expansion = 2, bool noCreate = false, bool nonScaling = false)
    {
        var args = new List<object>();
        args.AddRange(new object[] {key});
        if (capacity != null)
            args.AddRange(new object[] {"CAPACITY", capacity});
        if (string.IsNullOrEmpty(error) == false)
            args.AddRange(new object[] {"ERROR", error});
        if (expansion != 2)
            args.Add(new object[] {"EXPANSION", expansion});
        if (noCreate)
            args.Add("NOCREATE");
        if (nonScaling)
            args.Add("NONSCALING");
    ...
    {
        return new RedisScanCommand<byte[]>(new RedisArray.Bytes("BF.SCANDUMP", key, iter));
    }
    ...
    public class RedisBfInfoCommand : RedisCommand<(long capacity, long size, long numberOfFilters, long numberOfItemsInserted,
        long expansionRate)>
    {
        public RedisBfInfoCommand(string command, params object[] args) : base(command, args)
        {
        }

        public override (long capacity, long size, long numberOfFilters, long numberOfItemsInserted, long expansionRate) Parse(
            RedisReader reader)
        {
            long capacity = 0;
            long size = 0;
            ...
            if (count % 2 != 0)
                throw new RedisProtocolException("BF.INFO 返回数据格式 1级 MultiBulk 长度应该为偶数");
    ...
    public static RedisStatus CfReserve(string key, long capacity, long? bucketSize = null, long? maxIterations = null,
        int? expansion = null)
    {
        var args = new List<object>();
        args.AddRange(new object[] {key, capacity});
        if (bucketSize != 2)
            args.AddRange(new object[] {"BUCKETSIZE", bucketSize});
        if (maxIterations != 2)
            args.AddRange(new object[] {"MAXITERATIONS", maxIterations});
        if (expansion != 2)
            args.AddRange(new object[] {"EXPANSION", expansion});
    ...
    public static RedisArray.Generic<bool> CfInsert(bool nx, string key, object[] items, long? capacity = null,
        bool noCreate = false)
    {
        var args = new List<object>();
        args.AddRange(new object[] {key});
    ...
    {
        return new RedisScanCommand<byte[]>(new RedisArray.Bytes("CF.SCANDUMP", key, iter));
    }
    ...
    public class RedisCfInfoCommand : RedisCommand<(long size, long numberOfBuckets, long numberOfFilter, long
        numberOfItemsInserted, long numberOfItemsDeleted, long bucketSize, long expansionRate, long maxIteration)>
    {
        public RedisCfInfoCommand(string command, params object[] args) : base(command, args)
        {
        }

        public override (long size, long numberOfBuckets, long numberOfFilter, long numberOfItemsInserted, long
            numberOfItemsDeleted, long bucketSize, long expansionRate, long maxIteration) Parse(RedisReader reader)
        {
            long size = 0;
            ...
            var count = reader.ReadInt(false);
            if (count % 2 != 0)
                throw new RedisProtocolException("CF.INFO 返回数据格式 1级 MultiBulk 长度应该为偶数");
            ...
            return (size, numberOfBuckets, numberOfFilter, numberOfItemsInserted, numberOfItemsDeleted, bucketSize, expansionRate,
                maxIteration);
        }
    }
    ...
    public static RedisArray.Generic<long> CmsIncrBy(string key, params (object item, long increment)[] items)
    {
        ...
        foreach (var item in items)
            args.AddRange(new[] {item.item, item.increment});
    ...
    {
        public RedisCmsInfoCommand(string command, params object[] args) : base(command, args)
        {
        }
        ...
        public override (long width, long depth, long count) Parse(RedisReader reader)
        {
            ...
            reader.ExpectType(RedisMessage.MultiBulk);
            var arrayCount = reader.ReadInt(false);
            if (arrayCount % 2 != 0)
                throw new RedisProtocolException("CMS.INFO 返回数据格式 1级 MultiBulk 长度应该为偶数");
    ...
    {
        public RedisTopkInfoCommand(string command, params object[] args) : base(command, args)
        {
        }
    ...
    public static class Sentinel
    {
        ...
        {
            return new RedisArray.Generic<RedisSentinelInfo>(
                new RedisHash.Generic<RedisSentinelInfo>("SENTINEL", "sentinels", masterName));
        }
        ...
        {
            return new RedisArray.Generic<RedisSlaveInfo>(
                new RedisHash.Generic<RedisSlaveInfo>("SENTINEL", "slaves", masterName));
        }
        ...
        {
            return new RedisTuple.Generic<string, int>.Single(new RedisString(null), new RedisString.Integer(null), "SENTINEL",
