...
class RedisTuple : RedisCommand<Tuple<string, string>>
{
    ...
    public abstract class Generic<T1, T2> : RedisCommand<Tuple<T1, T2>>
    {
        ...
        protected Generic(RedisCommand<T1> command1, RedisCommand<T2> command2, string command, params object[] args) : base(
            command, args)
        {
            _command1 = command1;
            _command2 = command2;
        ...
        {
            public Repeating(RedisCommand<T1> command1, RedisCommand<T2> command2, string command, params object[] args) : base(
                command1, command2, command, args)
            {
            }
        ...
        {
            public Single(RedisCommand<T1> command1, RedisCommand<T2> command2, string command, params object[] args) : base(
                command1, command2, command, args)
            {
            }
    ...
    public abstract class Generic<T1, T2, T3> : RedisCommand<Tuple<T1, T2, T3>>
    {
        ...
        protected Generic(RedisCommand<T1> command1, RedisCommand<T2> command2, RedisCommand<T3> command3, string command,
            params object[] args) : base(command, args)
        {
            _command1 = command1;
            _command2 = command2;
            _command3 = command3;
        ...
        {
            public Repeating(RedisCommand<T1> command1, RedisCommand<T2> command2, RedisCommand<T3> command3, string command,
                params object[] args) : base(command1, command2, command3, command, args)
            {
            }
        ...
        {
            public Single(RedisCommand<T1> command1, RedisCommand<T2> command2, RedisCommand<T3> command3, string command,
                params object[] args) : base(command1, command2, command3, command, args)
            {
            }
    ...
    public abstract class Generic<T1, T2, T3, T4> : RedisCommand<Tuple<T1, T2, T3, T4>>
    {
        ...
        protected Generic(RedisCommand<T1> command1, RedisCommand<T2> command2, RedisCommand<T3> command3,
            RedisCommand<T4> command4, string command, params object[] args) : base(command, args)
        {
            _command1 = command1;
            _command2 = command2;
            _command3 = command3;
        ...
        {
            return Tuple.Create(_command1.Parse(reader), _command2 == null ? default(T2) : _command2.Parse(reader),
        ...
        {
            public Repeating(RedisCommand<T1> command1, RedisCommand<T2> command2, RedisCommand<T3> command3,
                RedisCommand<T4> command4, string command, params object[] args) : base(command1, command2, command3, command4,
                command, args)
            {
            }
        ...
        {
            public Single(RedisCommand<T1> command1, RedisCommand<T2> command2, RedisCommand<T3> command3,
                RedisCommand<T4> command4, string command, params object[] args) : base(command1, command2, command3, command4,
                command, args)
            {
            }
