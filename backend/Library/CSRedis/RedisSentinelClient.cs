...
public partial class RedisSentinelClient : IDisposable
{
    ...
    public RedisSentinelClient(string host) : this(host, DefaultPort)
    {
    }
    ...
    public RedisSentinelClient(string host, int port) : this(host, port, DefaultSSL)
    {
    }
    ...
    public RedisSentinelClient(string host, int port, bool ssl) : this(new RedisSocket(ssl), new DnsEndPoint(host, port),
        DefaultConcurrency, DefaultBufferSize)
    {
    }

    internal RedisSentinelClient(IRedisSocket socket, EndPoint endpoint) : this(socket, endpoint, DefaultConcurrency,
        DefaultBufferSize)
    {
    }
