...
public partial class CSRedisClient : IDisposable
{
    ...
    readonly DateTime _dt1970 = new DateTime(1970, 1, 1);
    ...
    {
        if (CurrentSerialize != null)
            return CurrentSerialize(value);
        if (Serialize != null)
    ...
    {
        if (CurrentDeserialize != null)
            return (T) CurrentDeserialize(value, typeof(T));
        if (Deserialize != null)
    ...
    internal object SerializeRedisValueInternal(object value)
    {
        ...
        if (typename == "System.Byte[" || typename == "System.String")
            return value;
        ...
        if (type.IsValueType)
        {
            ...
            switch (basename)
            {
                ...
                case "System.DateTime":
                    return ((DateTime) value).ToString("yyyy-MM-ddTHH:mm:sszzzz", DateTimeFormatInfo.InvariantInfo);
    ...
    internal T DeserializeRedisValueInternal<T>(byte[] value)
    {
        ...
        if (typename == "System.String")
            return (T) Convert.ChangeType(Nodes.First().Value.Encoding.GetString(value), type);
        if (typename == "System.Boolean[")
            return (T) Convert.ChangeType(value.Select(a => a == 49).ToArray(), type);
        ...
        if (type.IsValueType)
        {
            ...
            switch (basename)
            {
                case "System.Boolean":
                    ...
                    break;
                case "System.Byte":
                    if (byte.TryParse(valueStr, out var trybyte))
                        obj = trybyte;
                    break;
                case "System.Char":
                    ...
                    break;
                case "System.Decimal":
                    if (Decimal.TryParse(valueStr, out var trydec))
                        obj = trydec;
                    break;
                case "System.Double":
                    if (Double.TryParse(valueStr, out var trydb))
                        obj = trydb;
                    break;
                case "System.Single":
                    if (Single.TryParse(valueStr, out var trysg))
                        obj = trysg;
                    break;
                case "System.Int32":
                    if (Int32.TryParse(valueStr, out var tryint32))
                        obj = tryint32;
                    break;
                case "System.Int64":
                    if (Int64.TryParse(valueStr, out var tryint64))
                        obj = tryint64;
                    break;
                case "System.SByte":
                    if (SByte.TryParse(valueStr, out var trysb))
                        obj = trysb;
                    break;
                case "System.Int16":
                    if (Int16.TryParse(valueStr, out var tryint16))
                        obj = tryint16;
                    break;
                case "System.UInt32":
                    if (UInt32.TryParse(valueStr, out var tryuint32))
                        obj = tryuint32;
                    break;
                case "System.UInt64":
                    if (UInt64.TryParse(valueStr, out var tryuint64))
                        obj = tryuint64;
                    break;
                case "System.UInt16":
                    if (UInt16.TryParse(valueStr, out var tryuint16))
                        obj = tryuint16;
                    break;
                case "System.DateTime":
                    if (DateTime.TryParse(valueStr, out var trydt))
                        obj = trydt;
                    break;
                case "System.DateTimeOffset":
                    if (DateTimeOffset.TryParse(valueStr, out var trydtos))
                        obj = trydtos;
                    break;
                case "System.TimeSpan":
                    if (Int64.TryParse(valueStr, out tryint64))
                        obj = new TimeSpan(tryint64);
                    break;
                case "System.Guid":
                    if (Guid.TryParse(valueStr, out var tryguid))
                        obj = tryguid;
                    break;
                default:
                    isElse = true;
        ...
        return DeserializeObject<T>(valueStr);
    }
    ...
    internal T[] DeserializeRedisValueArrayInternal<T>(byte[][] value)
    {
        ...
        for (var a = 0; a < value.Length; a++)
            list[a] = DeserializeRedisValueInternal<T>(value[a]);
        return list;
    }
    ...
    internal (T1, T2)[] DeserializeRedisValueTuple1Internal<T1, T2>(Tuple<byte[], T2>[] value)
    {
        ...
        for (var a = 0; a < value.Length; a++)
            list[a] = (DeserializeRedisValueInternal<T1>(value[a].Item1), value[a].Item2);
        return list;
    }
    ...
    internal (T2, T1)[] DeserializeRedisValueTuple2Internal<T2, T1>(Tuple<T2, byte[]>[] value)
    {
        ...
        for (var a = 0; a < value.Length; a++)
            list[a] = (value[a].Item1, DeserializeRedisValueInternal<T1>(value[a].Item2));
        return list;
    }
    ...
    internal Dictionary<TKey, TValue> DeserializeRedisValueDictionaryInternal<TKey, TValue>(Dictionary<TKey, byte[]> value)
    {
        ...
        foreach (var kv in value)
            dic.Add(kv.Key, DeserializeRedisValueInternal<TValue>(kv.Value));
        return dic;
    }
    ...
    public CSRedisClient(string connectionString, string[] sentinels, bool readOnly = false) : this(null, sentinels, readOnly,
    ...
    public CSRedisClient(string connectionString, string[] sentinels, bool readOnly, SentinelMasterConverter convert) : this(null,
        sentinels, readOnly, convert, connectionString)
    {
    }
    ...
    public CSRedisClient(Func<string, string> NodeRule, params string[] connectionStrings) : this(NodeRule, null, false, null,
        connectionStrings)
    {
    }

    protected CSRedisClient(Func<string, string> NodeRule, string[] sentinels, bool readOnly,
        SentinelMasterConverter convert = null, params string[] connectionStrings)
    {
        if (connectionStrings == null || !connectionStrings.Any())
            throw new Exception("Redis ConnectionString 未设置");
        ...
        if (sentinels?.Any() == true)
        {
            if (connectionStrings.Length > 1)
                throw new Exception("Redis Sentinel 不可设置多个 ConnectionString");
        ...
        NodeRuleRaw = key =>
        {
            ...
            if (SlotCache.TryGetValue(slot, out var slotIndex) && NodesIndex.TryGetValue(slotIndex, out var slotKey))
            {
                if (Nodes.TryGetValue(slotKey, out var b) && b.IsAvailable == false)
                {
                    ...
                    if (string.IsNullOrEmpty(availableNode.Key) == false)
                        return availableNode.Key; //随便连向一个可用的节点
                }

                return slotKey; //按上一次 MOVED 记录查找节点
            }

            if (NodeRuleExternal == null)
            {
                if (string.IsNullOrEmpty(prefix) == false)
                    slot = GetClusterSlot(key ?? string.Empty);
            ...
            return NodeRuleExternal(key);
        };
        NodeRuleExternal = NodeRule;
        ...
        foreach (var connectionString in connectionStrings)
        {
            ...
            if (Nodes.ContainsKey(nodeKey))
                throw new Exception($"Node: {nodeKey} 重复，请检查");
            if (TryAddNode(nodeKey, pool) == false)
            {
                pool.Dispose();
                pool = null;
        ...
        NodesServerManager = new NodesServerManagerProvider(this);
    ...
    bool BackgroundGetSentinelMasterValueIng;
    readonly object BackgroundGetSentinelMasterValueIngLock = new object();
    ...
    T GetAndExecute<T>(RedisClientPool pool, Func<Object<RedisClient>, T> handler, int jump = 100, int errtimes = 0)
    {
            ...
            while (true)
            {
                ...
                catch (RedisException ex3)
                {
                    ...
                    if (redirect == null || jump <= 0)
                    {
                        ...
                        {
                            //哨兵轮询
                            if (pool.SetUnavailable(ex, obj.LastGetTimeCopy))
        ...
        var redirectHander = redirect.Value.isMoved
            ? handler
            : redirectObj =>
            {
        ...
        return GetAndExecute(GetRedirectPool(redirect.Value, pool), redirectHander, jump - 1);
    }
    ...
    bool TryAddNode(string nodeKey, RedisClientPool pool)
    {
        if (Nodes.TryAdd(nodeKey, pool))
        {
            ...
            if (NodesIndex.TryAdd(nodeIndex, nodeKey) && NodesKey.TryAdd(nodeKey, nodeIndex))
                return true;
        ...
        if (Nodes.TryGetValue(nodeKey, out var movedPool) == false)
        {
            lock (NodesLock)
            {
                if (Nodes.TryGetValue(nodeKey, out movedPool) == false)
                {
                    ...
                    if (TryAddNode(nodeKey, movedPool) == false)
                    {
                        movedPool.Dispose();
                        movedPool = null;
                    }
    ...
    (bool isMoved, bool isAsk, ushort slot, string endpoint)? ParseClusterRedirect(Exception ex)
    {
        if (ex == null)
            return null;
        var isMoved = ex.Message.StartsWith("MOVED ");
        var isAsk = ex.Message.StartsWith("ASK ");
        if (isMoved == false && isAsk == false)
            return null;
        var parts = ex.Message.Split(new[] {"\r\n"}, StringSplitOptions.None).FirstOrDefault().Split(new[] {' '}, 3);
        if (parts.Length != 3 || ushort.TryParse(parts[1], out var slot) == false)
            return null;
    ...
    T NodesNotSupport<T>(string[] keys, T defaultValue, Func<Object<RedisClient>, string[], T> callback)
    {
        ...
        if (rules.Count() > 1)
            throw new Exception("由于开启了分区模式，keys 分散在多个节点，无法使用此功能");
        var pool = Nodes.TryGetValue(rules.First(), out var b) ? b : Nodes.First().Value;
        var rkeys = new string[keys.Length];
        for (var a = 0; a < keys.Length; a++)
            rkeys[a] = string.Concat(pool.Prefix, keys[a]);
        if (rkeys.Length == 0)
            return defaultValue;
    ...
    {
        if (IsMultiNode)
            throw new Exception("由于开启了分区模式，无法使用此功能");
        return ExecuteScalar(key, callback);
    }
    ...
    RedisClientPool GetNodeOrThrowNotFound(string nodeKey)
    {
        ...
        if (Nodes.ContainsKey(nodeKey) == false)
            throw new Exception($"找不到群集节点：{nodeKey}");
    ...
    public T CacheShell<T>(string key, int timeoutSeconds, Func<T> getData)
    {
        ...
        if (cacheValue != null)
        {
            try
            {
                return DeserializeObject<T>(cacheValue);
            }
            catch
            {
                Del(key);
        ...
        var ret = getData();
        Set(key, SerializeObject(ret), timeoutSeconds);
        return ret;
    }
    ...
    public T CacheShell<T>(string key, string field, int timeoutSeconds, Func<T> getData)
    {
        ...
        if (cacheValue != null)
        {
            try
            {
                var value = DeserializeObject<(T, long)>(cacheValue);
        ...
        var ret = getData();
        HSet(key, field, SerializeObject((ret, (long) DateTime.Now.Subtract(_dt1970).TotalSeconds)));
        return ret;
    }
    ...
    /// <returns></returns>
    public (string key, T value)[] CacheShell<T>(string key, string[] fields, int timeoutSeconds,
        Func<string[], (string, T)[]> getData)
    {
        ...
        for (var a = 0; a < ret.Length; a++)
        {
            if (cacheValue[a] != null)
            {
                try
                {
                    var value = DeserializeObject<(T, long)>(cacheValue[a]);
                    if (DateTime.Now.Subtract(_dt1970.AddSeconds(value.Item2)).TotalSeconds <= timeoutSeconds)
                    {
        ...
        if (fieldsMGet.Any())
        {
            ...
            {
                if (fieldsMGet.ContainsKey(d.Item1) == false)
                    throw new Exception(
                        $"使用 CacheShell 请确认 getData 返回值 (string, T)[] 中的 Item1 值: {d.Item1} 存在于 输入参数: {string.Join(",", getDataIntput)}");
                ret[fieldsMGet[d.Item1]] = d;
                mset[msetIndex++] = d.Item1;
                mset[msetIndex++] = SerializeObject((d.Item2, (long) DateTime.Now.Subtract(_dt1970).TotalSeconds));
            ...
            foreach (var fieldNull in fieldsMGet.Keys)
            {
                ...
                mset[msetIndex++] = SerializeObject((default(T), (long) DateTime.Now.Subtract(_dt1970).TotalSeconds));
            }
    ...
    internal T ExecuteScalar<T>(string key, Func<Object<RedisClient>, string, T> hander)
    {
        if (key == null)
            return default(T);
        var pool = NodeRuleRaw == null || Nodes.Count == 1
            ? Nodes.First().Value
            : (Nodes.TryGetValue(NodeRuleRaw(key), out var b) ? b : Nodes.First().Value);
    ...
    internal T[] ExecuteArray<T>(string[] key, Func<Object<RedisClient>, string[], T[]> hander)
    {
        ...
        for (var a = 0; a < key.Length; a++)
        {
            ...
            if (rules.ContainsKey(rule))
                rules[rule].Add((key[a], a));
            else
                rules.Add(rule, new List<(string, int)> {(key[a], a)});
        }

        var ret = new T[key.Length];
    ...
    internal long ExecuteNonQuery(string[] key, Func<Object<RedisClient>, string[], long> hander)
    {
        ...
        for (var a = 0; a < key.Length; a++)
        {
            var rule = NodeRuleRaw(key[a]);
            if (rules.ContainsKey(rule))
                rules[rule].Add(key[a]);
            else
                rules.Add(rule, new List<string> {key[a]});
        }
    ...
    public partial class NodesServerManagerProvider
    {
        ...
        /// </summary>
        /// <returns></returns>
        public (string node, string value)[] BgRewriteAof() =>
            _csredis.Nodes.Values.Select(a => _csredis.GetAndExecute(a, c => (a.Key, c.Value.BgRewriteAof()))).ToArray();

        /// <summary>
        /// 在后台异步保存当前数据库的数据到磁盘
        /// </summary>
        /// <returns></returns>
        public (string node, string value)[] BgSave() =>
            _csredis.Nodes.Values.Select(a => _csredis.GetAndExecute(a, c => (a.Key, c.Value.BgSave()))).ToArray();
        ...
        /// <returns></returns>
        public (string node, string value)[] ClientKill(string ip, int port) =>
            _csredis.Nodes.Values.Select(a => _csredis.GetAndExecute(a, c => (a.Key, c.Value.ClientKill(ip, port)))).ToArray();
        ...
        /// <returns></returns>
        public (string node, long value)[] ClientKill(string addr = null, string id = null, ClientKillType? type = null,
            bool? skipMe = null) =>
            _csredis.Nodes.Values.Select(a =>
                _csredis.GetAndExecute(a, c => (a.Key, c.Value.ClientKill(addr, id, type?.ToString(), skipMe)))).ToArray();

        /// <summary>
        /// 获取连接到服务器的客户端连接列表
        /// </summary>
        /// <returns></returns>
        public (string node, string value)[] ClientList() =>
            _csredis.Nodes.Values.Select(a => _csredis.GetAndExecute(a, c => (a.Key, c.Value.ClientList()))).ToArray();

        /// <summary>
        /// 获取连接的名称
        /// </summary>
        /// <returns></returns>
        public (string node, string value)[] ClientGetName() =>
            _csredis.Nodes.Values.Select(a => _csredis.GetAndExecute(a, c => (a.Key, c.Value.ClientGetName()))).ToArray();
        ...
        /// <returns></returns>
        public (string node, string value)[] ClientPause(TimeSpan timeout) =>
            _csredis.Nodes.Values.Select(a => _csredis.GetAndExecute(a, c => (a.Key, c.Value.ClientPause(timeout)))).ToArray();
        ...
        /// <returns></returns>
        public (string node, string value)[] ClientSetName(string connectionName) =>
            _csredis.Nodes.Values.Select(a => _csredis.GetAndExecute(a, c => (a.Key, c.Value.ClientSetName(connectionName))))
                .ToArray();
        ...
        /// </summary>
        /// <returns></returns>
        public (string node, DateTime value)[] Time() =>
            _csredis.Nodes.Values.Select(a => _csredis.GetAndExecute(a, c => (a.Key, c.Value.Time()))).ToArray();
        ...
        /// <returns></returns>
        public (string node, Dictionary<string, string> value)[] ConfigGet(string parameter) =>
            _csredis.Nodes.Values.Select(a =>
                    _csredis.GetAndExecute(a,
                        c => (a.Key, c.Value.ConfigGet(parameter).ToDictionary(z => z.Item1, y => y.Item2))))
                .ToArray();
        ...
        /// </summary>
        /// <returns></returns>
        public (string node, string value)[] ConfigRewrite() =>
            _csredis.Nodes.Values.Select(a => _csredis.GetAndExecute(a, c => (a.Key, c.Value.ConfigRewrite()))).ToArray();
        ...
        /// <returns></returns>
        public (string node, string value)[] ConfigSet(string parameter, string value) =>
            _csredis.Nodes.Values.Select(a => _csredis.GetAndExecute(a, c => (a.Key, c.Value.ConfigSet(parameter, value))))
                .ToArray();
        ...
        /// </summary>
        /// <returns></returns>
        public (string node, string value)[] ConfigResetStat() =>
            _csredis.Nodes.Values.Select(a => _csredis.GetAndExecute(a, c => (a.Key, c.Value.ConfigResetStat()))).ToArray();

        /// <summary>
        /// 返回当前数据库的 key 的数量
        /// </summary>
        /// <returns></returns>
        public (string node, long value)[] DbSize() =>
            _csredis.Nodes.Values.Select(a => _csredis.GetAndExecute(a, c => (a.Key, c.Value.DbSize()))).ToArray();

        /// <summary>
        /// 让 Redis 服务崩溃
        /// </summary>
        /// <returns></returns>
        public (string node, string value)[] DebugSegFault() =>
            _csredis.Nodes.Values.Select(a => _csredis.GetAndExecute(a, c => (a.Key, c.Value.DebugSegFault()))).ToArray();

        /// <summary>
        /// 删除所有数据库的所有key
        /// </summary>
        /// <returns></returns>
        public (string node, string value)[] FlushAll() =>
            _csredis.Nodes.Values.Select(a => _csredis.GetAndExecute(a, c => (a.Key, c.Value.FlushAll()))).ToArray();

        /// <summary>
        /// 删除当前数据库的所有key
        /// </summary>
        /// <returns></returns>
        public (string node, string value)[] FlushDb() =>
            _csredis.Nodes.Values.Select(a => _csredis.GetAndExecute(a, c => (a.Key, c.Value.FlushDb()))).ToArray();
        ...
        /// <returns></returns>
        public (string node, string value)[] Info(InfoSection? section = null) =>
            _csredis.Nodes.Values.Select(a => _csredis.GetAndExecute(a, c => (a.Key, c.Value.Info(section?.ToString()))))
                .ToArray();
        ...
        /// </summary>
        /// <returns></returns>
        public (string node, DateTime value)[] LastSave() =>
            _csredis.Nodes.Values.Select(a => _csredis.GetAndExecute(a, c => (a.Key, c.Value.LastSave()))).ToArray();
        ...
        /// </summary>
        /// <returns></returns>
        public (string node, RedisRole value)[] Role() =>
            _csredis.Nodes.Values.Select(a => _csredis.GetAndExecute(a, c => (a.Key, c.Value.Role()))).ToArray();

        /// <summary>
        /// 同步保存数据到硬盘
        /// </summary>
        /// <returns></returns>
        public (string node, string value)[] Save() =>
            _csredis.Nodes.Values.Select(a => _csredis.GetAndExecute(a, c => (a.Key, c.Value.Save()))).ToArray();
        ...
        /// <returns></returns>
        public (string node, string value)[] Shutdown(bool isSave = true) =>
            _csredis.Nodes.Values.Select(a => _csredis.GetAndExecute(a, c => (a.Key, c.Value.Shutdown(isSave)))).ToArray();
        ...
        /// <param name="port">端口</param>
        /// <returns></returns>
        public (string node, string value)[] SlaveOf(string host, int port) =>
            _csredis.Nodes.Values.Select(a => _csredis.GetAndExecute(a, c => (a.Key, c.Value.SlaveOf(host, port)))).ToArray();

        /// <summary>
        /// 从属服务器执行命令 SLAVEOF NO ONE 将使得这个从属服务器关闭复制功能，并从从属服务器转变回主服务器，原来同步所得的数据集不会被丢弃。
        /// </summary>
        /// <returns></returns>
        public (string node, string value)[] SlaveOfNoOne() =>
            _csredis.Nodes.Values.Select(a => _csredis.GetAndExecute(a, c => (a.Key, c.Value.SlaveOfNoOne()))).ToArray();
        ...
        /// <returns></returns>
        public (string node, RedisSlowLogEntry[] value)[] SlowLogGet(long? count = null) =>
            _csredis.Nodes.Values.Select(a => _csredis.GetAndExecute(a, c => (a.Key, c.Value.SlowLogGet(count)))).ToArray();

        /// <summary>
        /// 管理 redis 的慢日志，总数量
        /// </summary>
        /// <returns></returns>
        public (string node, long value)[] SlowLogLen() =>
            _csredis.Nodes.Values.Select(a => _csredis.GetAndExecute(a, c => (a.Key, c.Value.SlowLogLen()))).ToArray();

        /// <summary>
        /// 管理 redis 的慢日志，清空
        /// </summary>
        /// <returns></returns>
        public (string node, string value)[] SlowLogReset() =>
            _csredis.Nodes.Values.Select(a => _csredis.GetAndExecute(a, c => (a.Key, c.Value.SlowLogReset()))).ToArray();

        /// <summary>
        /// 用于复制功能(replication)的内部命令
        /// </summary>
        /// <returns></returns>
        public (string node, byte[] value)[] Sync() =>
            _csredis.Nodes.Values.Select(a => _csredis.GetAndExecute(a, c => (a.Key, c.Value.Sync()))).ToArray();
    }
    ...
    public NodeServerManagerProvider NodeServerManager(string node) =>
        new NodeServerManagerProvider(this, GetNodeOrThrowNotFound(node));
    ...
    public partial class NodeServerManagerProvider
    {
        ...
        /// <param name="skipMe">跳过自己</param>
        /// <returns></returns>
        public long ClientKill(string addr = null, string id = null, ClientKillType? type = null, bool? skipMe = null) =>
            _csredis.GetAndExecute(_pool, c => c.Value.ClientKill(addr, id, type?.ToString(), skipMe));

        public enum ClientKillType
        {
            normal,
            slave,
            pubsub
        ...
        public string ClientSetName(string connectionName) =>
            _csredis.GetAndExecute(_pool, c => c.Value.ClientSetName(connectionName));
        ...
        /// <param name="parameter">参数</param>
        /// <returns></returns>
        public Dictionary<string, string> ConfigGet(string parameter) =>
            _csredis.GetAndExecute(_pool, c => c.Value.ConfigGet(parameter)).ToDictionary(z => z.Item1, y => y.Item2);
        ...
        public string ConfigSet(string parameter, string value) =>
            _csredis.GetAndExecute(_pool, c => c.Value.ConfigSet(parameter, value));
        ...
        public RedisSlowLogEntry[] SlowLogGet(long? count = null) =>
            _csredis.GetAndExecute(_pool, c => c.Value.SlowLogGet(count));
    ...
    private bool Auth(string nodeKey, string password) =>
        GetAndExecute(GetNodeOrThrowNotFound(nodeKey), c => c.Value.Auth(password)) == "OK";
    ...
    public string Echo(string nodeKey, string message) =>
        GetAndExecute(GetNodeOrThrowNotFound(nodeKey), c => c.Value.Echo(message));
    ...
    private bool Select(string nodeKey, int index) =>
        GetAndExecute(GetNodeOrThrowNotFound(nodeKey), c => c.Value.Select(index)) == "OK";
    ...
    {
        var args2 = args?.Select(z => SerializeRedisValueInternal(z)).ToArray();
    ...
    public bool[] ScriptExists(params string[] sha1) =>
        Nodes.Select(a => GetAndExecute(a.Value, c => c.Value.ScriptExists(sha1))?.Where(z => z == false).Any() == false)
            .ToArray();
    ...
    public string ScriptLoad(string script) =>
        Nodes.Select(a => GetAndExecute(a.Value, c => (c.Pool.Policy.Name.ToString(), c.Value.ScriptLoad(script)))).First().Item2;
    ...
    {
        var msgid = HIncrBy("csredisclient:Publish:msgid", channel);
    ...
    public long PublishNoneMessageId(string channel, string message) =>
        ExecuteScalar(channel, (c, k) => c.Value.Publish(channel, message));
    ...
    public Dictionary<string, long> PubSubNumSub(params string[] channels) =>
        ExecuteArray(channels, (c, k) =>
        {
            var prefix = (c.Pool as RedisClientPool).Prefix;
            return c.Value.PubSubNumSub(k.Select(z =>
                string.IsNullOrEmpty(prefix) == false && z.StartsWith(prefix) ? z.Substring(prefix.Length) : z).ToArray());
    ...
    public SubscribeObject Subscribe(params (string, Action<SubscribeMessageEventArgs>)[] channels)
    {
        ...
        for (var a = 0; a < chans.Length; a++)
        {
            ...
            if (rules.ContainsKey(rule))
                rules[rule].Add(chans[a]);
            else
                rules.Add(rule, new List<string> {chans[a]});
        }

        var subscrs = new List<(string[] keys, Object<RedisClient> conn)>();
        foreach (var r in rules)
        {
    ...
    public class SubscribeObject : IDisposable
    {
        ...
        internal SubscribeObject(CSRedisClient redis, string[] channels, (string[] chans, Object<RedisClient> conn)[] subscrs,
            Dictionary<string, Action<SubscribeMessageEventArgs>> onMessageDic)
        {
            Redis = redis;
            Channels = channels;
            Subscrs = subscrs;
            OnMessageDic = onMessageDic;
        ...
        private void Subscribe(object state)
        {
            ...
            EventHandler<RedisSubscriptionReceivedEventArgs> SubscriptionReceived = (a, b) =>
            {
                try
                {
                    if (b.Message.Type == "message" && OnMessageDic != null &&
                        OnMessageDic.TryGetValue(b.Message.Channel, out var action))
                    {
                        ...
                        if (msgidIdx != -1 && long.TryParse(b.Message.Body.Substring(0, msgidIdx), out var trylong))
                            ...
                            action(new SubscribeMessageEventArgs
                            {
                                MessageId = 0, Body = b.Message.Body, Channel = b.Message.Channel
                            });
                        else
                        {
                            testKeepalived = true;
                ...
                catch (Exception ex)
                {
                    ...
                    Console.ForegroundColor = ConsoleColor.White;
                    Console.Write(
                        $"订阅方法执行出错【{pool.Key}】(channels:{string.Join(",", Channels)})/(chans:{string.Join(",", subscr.chans)})：{ex.Message}\r\n{ex.StackTrace}");
                    Console.BackgroundColor = bgcolor;
                    Console.ForegroundColor = forecolor;
                    Console.WriteLine();
                }
            ...
            var isSubscribeing = false;
            var isKeepliveReSubscribe = false;
            var keeplive = new Timer(state2 =>
            {
                if (isSubscribeing == false)
                    return;
                try
                {
                    foreach (var chan in subscr.chans)
                    {
                        ...
                        if (testKeepalived == false)
                        {
                            ...
                            try
                            {
                                subscr.conn.Value.Socket?.Shutdown(SocketShutdown.Both);
                            }
                            catch
                            {
                            }
            ...
            while (IsUnsubscribed == false)
            {
                try
                {
                    ...
                    Console.ForegroundColor = ConsoleColor.White;
                    Console.Write(
                        $"正在订阅【{pool.Key}】(channels:{string.Join(",", Channels)})/(chans:{string.Join(",", subscr.chans)})");
                    Console.BackgroundColor = bgcolor;
                    Console.ForegroundColor = forecolor;
                    Console.WriteLine();
                ...
                catch (Exception ex)
                {
                    ...
                    Console.ForegroundColor = ConsoleColor.White;
                    Console.Write(
                        $"订阅出错【{pool.Key}】(channels:{string.Join(",", Channels)})/(chans:{string.Join(",", subscr.chans)})：{ex.Message}，3秒后重连。。。");
                    Console.BackgroundColor = bgcolor;
                    Console.ForegroundColor = forecolor;
                    Console.WriteLine();
        ...
        public void Dispose()
        {
            ...
            if (Subscrs != null)
            {
                foreach (var subscr in Subscrs)
                {
                    ...
                    try
                    {
                        subscr.conn.Value.ReceiveTimeout = (subscr.conn.Pool as RedisClientPool)._policy._syncTimeout;
                    }
                    catch
                    {
                    }
    ...
    public PSubscribeObject PSubscribe(string[] channelPatterns, Action<PSubscribePMessageEventArgs> pmessage)
    {
        ...
        var redisConnections = new List<Object<RedisClient>>();
    ...
    public class PSubscribeObject : IDisposable
    {
        ...
        internal PSubscribeObject(CSRedisClient redis, string[] channels, Object<RedisClient>[] redisConnections,
            Action<PSubscribePMessageEventArgs> onPMessage)
        {
            Redis = redis;
            Channels = channels;
            RedisConnections = redisConnections;
            OnPMessage = onPMessage;
            IsPUnsubscribed = false;
        ...
        private void PSubscribe(object state)
        {
            ...
            EventHandler<RedisSubscriptionReceivedEventArgs> SubscriptionReceived = (a, b) =>
            {
                try
                {
                    if (b.Message.Type == "pmessage" && OnPMessage != null)
                    {
                        var msgidIdx = b.Message.Body.IndexOf('|');
                        if (msgidIdx != -1 && long.TryParse(b.Message.Body.Substring(0, msgidIdx), out var trylong))
                        {
...
return 0", $"CSRedisPSubscribe{psubscribeKey}", "", trylong.ToString());
                            if (readed?.ToString() == "1")
                                OnPMessage(new PSubscribePMessageEventArgs
                                {
                                    Body = b.Message.Body.Substring(msgidIdx + 1),
                                    Channel = b.Message.Channel,
                                    MessageId = trylong,
                            ...
                            OnPMessage(new PSubscribePMessageEventArgs
                            {
                                Body = b.Message.Body, Channel = b.Message.Channel, MessageId = 0, Pattern = b.Message.Pattern
                            });
                    }
                }
                catch (Exception ex)
            ...
            while (true)
            {
                try
                {
                    ...
                    conn.Value.PSubscribe(Channels);
        ...
        public void Dispose()
        {
            ...
            if (RedisConnections != null)
            {
                foreach (var conn in RedisConnections)
                {
                    ...
                    try
                    {
                        conn.Value.ReceiveTimeout = (conn.Pool as RedisClientPool)._policy._syncTimeout;
                    }
                    catch
                    {
                    }
    ...
    {
        HSetNx($"{listKey}_SubscribeListBroadcast", clientId, 1);
        var subobj = new SubscribeListBroadcastObject
        {
            OnDispose = () => { HDel($"{listKey}_SubscribeListBroadcast", clientId); }
        };
        //订阅其他端转发的消息
        subobj.SubscribeLists.Add(SubscribeList($"{listKey}_{clientId}", onMessage));
        //订阅主消息，接收消息后分发
        subobj.SubscribeLists.Add(SubscribeList(new[] {listKey}, (key, msg) =>
        {
            try
            {
                HSetNx($"{listKey}_SubscribeListBroadcast", clientId, 1);
                ...
                var clients = HKeys($"{listKey}_SubscribeListBroadcast");
                var pipe = StartPipe();
        ...
        AppDomain.CurrentDomain.ProcessExit += (s1, e1) => { subobj.Dispose(); };
        try
        {
            Console.CancelKeyPress += (s1, e1) =>
            {
    ...
    public class SubscribeListBroadcastObject : IDisposable
    {
        ...
        public void Dispose()
        {
            ...
            foreach (var sub in SubscribeLists)
                sub.Dispose();
        }
    }
    ...
    public SubscribeListObject SubscribeList(string listKey, Action<string> onMessage) =>
        SubscribeList(new[] {listKey}, (k, v) => onMessage(v), false);
    ...
    /// <returns></returns>
    public SubscribeListObject SubscribeList(string[] listKeys, Action<string, string> onMessage) =>
        SubscribeList(listKeys, onMessage, false);

    private SubscribeListObject SubscribeList(string[] listKeys, Action<string, string> onMessage, bool ignoreEmpty)
    {
        if (listKeys == null || listKeys.Any() == false)
            throw new ArgumentException("参数 listKey 不可为空");
        ...
        new Thread(() =>
        {
            while (subobj.IsUnsubscribed == false)
            {
                try
                {
                    if (isMultiKey)
                    {
                        var msg = BLPopWithKey(5, listKeys);
                        if (msg != null)
    ...
    public bool PfAdd<T>(string key, params T[] elements)
    {
        if (elements == null || elements.Any() == false)
            return false;
        var args = elements.Select(z => SerializeRedisValueInternal(z)).ToArray();
    ...
    public bool PfMerge(string destKey, params string[] sourceKeys) =>
        NodesNotSupport(new[] {destKey}.Concat(sourceKeys).ToArray(), false,
            (c, k) => c.Value.PfMerge(k.First(), k.Skip(1).ToArray()) == "OK");
    ...
    public (string member, decimal score)[] ZPopMax(string key, long count) =>
        ExecuteScalar(key, (c, k) => c.Value.ZPopMax(k, count)).Select(a => (a.Item1, a.Item2)).ToArray();
    ...
    public (T member, decimal score)[] ZPopMax<T>(string key, long count) =>
        DeserializeRedisValueTuple1Internal<T, decimal>(ExecuteScalar(key, (c, k) => c.Value.ZPopMaxBytes(k, count)));
    ...
    public (string member, decimal score)[] ZPopMin(string key, long count) =>
        ExecuteScalar(key, (c, k) => c.Value.ZPopMin(k, count)).Select(a => (a.Item1, a.Item2)).ToArray();
    ...
    public (T member, decimal score)[] ZPopMin<T>(string key, long count) =>
        DeserializeRedisValueTuple1Internal<T, decimal>(ExecuteScalar(key, (c, k) => c.Value.ZPopMinBytes(k, count)));
    ...
    {
        if (scoreMembers == null || scoreMembers.Any() == false)
            return 0;
        var args = scoreMembers.Select(a => new Tuple<decimal, object>(a.Item1, SerializeRedisValueInternal(a.Item2))).ToArray();
    ...
    {
        var args = SerializeRedisValueInternal(member);
    ...
    public long ZInterStore(string destination, decimal[] weights, RedisAggregate aggregate, params string[] keys)
    {
        if (keys == null || keys.Length == 0)
            throw new Exception("keys 参数不可为空");
        if (weights != null && weights.Length != keys.Length)
            throw new Exception("weights 和 keys 参数长度必须相同");
        return NodesNotSupport(new[] {destination}.Concat(keys).ToArray(), 0,
            (c, k) => c.Value.ZInterStore(k.First(), weights, aggregate, k.Skip(1).ToArray()));
    }
    ...
    /// <returns></returns>
    public string[] ZRange(string key, long start, long stop) => ExecuteScalar(key, (c, k) => c.Value.ZRange(k, start, stop));
    ...
    public T[] ZRange<T>(string key, long start, long stop) =>
        DeserializeRedisValueArrayInternal<T>(ExecuteScalar(key, (c, k) => c.Value.ZRangeBytes(k, start, stop)));
    ...
    public (string member, decimal score)[] ZRangeWithScores(string key, long start, long stop) =>
        ExecuteScalar(key, (c, k) => c.Value.ZRangeWithScores(k, start, stop)).Select(a => (a.Item1, a.Item2)).ToArray();
    ...
    public (T member, decimal score)[] ZRangeWithScores<T>(string key, long start, long stop) =>
        DeserializeRedisValueTuple1Internal<T, decimal>(ExecuteScalar(key,
            (c, k) => c.Value.ZRangeBytesWithScores(k, start, stop)));
    ...
    public string[] ZRangeByScore(string key, decimal min, decimal max, long? count = null, long offset = 0) =>
        ExecuteScalar(key,
            (c, k) => c.Value.ZRangeByScore(k, min == decimal.MinValue ? "-inf" : min.ToString(),
                max == decimal.MaxValue ? "+inf" : max.ToString(), false, offset, count));
    ...
    public T[] ZRangeByScore<T>(string key, decimal min, decimal max, long? count = null, long offset = 0) =>
        DeserializeRedisValueArrayInternal<T>(ExecuteScalar(key,
            (c, k) => c.Value.ZRangeBytesByScore(k, min == decimal.MinValue ? "-inf" : min.ToString(),
                max == decimal.MaxValue ? "+inf" : max.ToString(), false, offset, count)));
    ...
    public T[] ZRangeByScore<T>(string key, string min, string max, long? count = null, long offset = 0) =>
        DeserializeRedisValueArrayInternal<T>(ExecuteScalar(key,
            (c, k) => c.Value.ZRangeBytesByScore(k, min, max, false, offset, count)));
    ...
    /// <param name="offset">返回条件偏移位置</param>
    /// <returns></returns>
    public (string member, decimal score)[]
        ZRangeByScoreWithScores(string key, decimal min, decimal max, long? count = null, long offset = 0) =>
        ExecuteScalar(key,
            (c, k) => c.Value.ZRangeByScoreWithScores(k, min == decimal.MinValue ? "-inf" : min.ToString(),
                max == decimal.MaxValue ? "+inf" : max.ToString(), offset, count)).Select(z => (z.Item1, z.Item2)).ToArray();
    ...
    /// <param name="offset">返回条件偏移位置</param>
    /// <returns></returns>
    public (T member, decimal score)[]
        ZRangeByScoreWithScores<T>(string key, decimal min, decimal max, long? count = null, long offset = 0) =>
        DeserializeRedisValueTuple1Internal<T, decimal>(ExecuteScalar(key,
            (c, k) => c.Value.ZRangeBytesByScoreWithScores(k, min == decimal.MinValue ? "-inf" : min.ToString(),
                max == decimal.MaxValue ? "+inf" : max.ToString(), offset, count)));
    ...
    /// <returns></returns>
    public (string member, decimal score)[]
        ZRangeByScoreWithScores(string key, string min, string max, long? count = null, long offset = 0) =>
        ExecuteScalar(key, (c, k) => c.Value.ZRangeByScoreWithScores(k, min, max, offset, count)).Select(z => (z.Item1, z.Item2))
            .ToArray();
    ...
    /// <returns></returns>
    public (T member, decimal score)[]
        ZRangeByScoreWithScores<T>(string key, string min, string max, long? count = null, long offset = 0) =>
        DeserializeRedisValueTuple1Internal<T, decimal>(ExecuteScalar(key,
            (c, k) => c.Value.ZRangeBytesByScoreWithScores(k, min, max, offset, count)));
    ...
    {
        if (member == null || member.Any() == false)
            return 0;
        var args = member.Select(z => SerializeRedisValueInternal(z)).ToArray();
    ...
    public long ZRemRangeByRank(string key, long start, long stop) =>
        ExecuteScalar(key, (c, k) => c.Value.ZRemRangeByRank(k, start, stop));
    ...
    public long ZRemRangeByScore(string key, decimal min, decimal max) =>
        ExecuteScalar(key,
            (c, k) => c.Value.ZRemRangeByScore(k, min == decimal.MinValue ? "-inf" : min.ToString(),
                max == decimal.MaxValue ? "+inf" : max.ToString()));
    ...
    public long ZRemRangeByScore(string key, string min, string max) =>
        ExecuteScalar(key, (c, k) => c.Value.ZRemRangeByScore(k, min, max));
    ...
    public string[] ZRevRange(string key, long start, long stop) =>
        ExecuteScalar(key, (c, k) => c.Value.ZRevRange(k, start, stop));
    ...
    public T[] ZRevRange<T>(string key, long start, long stop) =>
        DeserializeRedisValueArrayInternal<T>(ExecuteScalar(key, (c, k) => c.Value.ZRevRangeBytes(k, start, stop)));
    ...
    public (string member, decimal score)[] ZRevRangeWithScores(string key, long start, long stop) =>
        ExecuteScalar(key, (c, k) => c.Value.ZRevRangeWithScores(k, start, stop)).Select(a => (a.Item1, a.Item2)).ToArray();
    ...
    public (T member, decimal score)[] ZRevRangeWithScores<T>(string key, long start, long stop) =>
        DeserializeRedisValueTuple1Internal<T, decimal>(ExecuteScalar(key,
            (c, k) => c.Value.ZRevRangeBytesWithScores(k, start, stop)));
    ...
    /// <param name="offset">返回条件偏移位置</param>
    /// <returns></returns>
    public string[] ZRevRangeByScore(string key, decimal max, decimal min, long? count = null, long? offset = 0) =>
        ExecuteScalar(key,
            (c, k) => c.Value.ZRevRangeByScore(k, max == decimal.MaxValue ? "+inf" : max.ToString(),
                min == decimal.MinValue ? "-inf" : min.ToString(), false, offset, count));
    ...
    public T[] ZRevRangeByScore<T>(string key, decimal max, decimal min, long? count = null, long offset = 0) =>
        DeserializeRedisValueArrayInternal<T>(ExecuteScalar(key,
            (c, k) => c.Value.ZRevRangeBytesByScore(k, max == decimal.MaxValue ? "+inf" : max.ToString(),
                min == decimal.MinValue ? "-inf" : min.ToString(), false, offset, count)));
    ...
    /// <param name="offset">返回条件偏移位置</param>
    /// <returns></returns>
    public string[] ZRevRangeByScore(string key, string max, string min, long? count = null, long? offset = 0) =>
        ExecuteScalar(key, (c, k) => c.Value.ZRevRangeByScore(k, max, min, false, offset, count));
    ...
    public T[] ZRevRangeByScore<T>(string key, string max, string min, long? count = null, long offset = 0) =>
        DeserializeRedisValueArrayInternal<T>(ExecuteScalar(key,
            (c, k) => c.Value.ZRevRangeBytesByScore(k, max, min, false, offset, count)));
    ...
    /// <returns></returns>
    public (string member, decimal score)[]
        ZRevRangeByScoreWithScores(string key, decimal max, decimal min, long? count = null, long offset = 0) =>
        ExecuteScalar(key,
            (c, k) => c.Value.ZRevRangeByScoreWithScores(k, max == decimal.MaxValue ? "+inf" : max.ToString(),
                min == decimal.MinValue ? "-inf" : min.ToString(), offset, count)).Select(z => (z.Item1, z.Item2)).ToArray();
    ...
    /// <returns></returns>
    public (T member, decimal score)[]
        ZRevRangeByScoreWithScores<T>(string key, decimal max, decimal min, long? count = null, long offset = 0) =>
        DeserializeRedisValueTuple1Internal<T, decimal>(ExecuteScalar(key,
            (c, k) => c.Value.ZRevRangeBytesByScoreWithScores(k, max == decimal.MaxValue ? "+inf" : max.ToString(),
                min == decimal.MinValue ? "-inf" : min.ToString(), offset, count)));
    ...
    /// <returns></returns>
    public (string member, decimal score)[]
        ZRevRangeByScoreWithScores(string key, string max, string min, long? count = null, long offset = 0) =>
        ExecuteScalar(key, (c, k) => c.Value.ZRevRangeByScoreWithScores(k, max, min, offset, count))
            .Select(z => (z.Item1, z.Item2)).ToArray();
    ...
    /// <returns></returns>
    public (T member, decimal score)[]
        ZRevRangeByScoreWithScores<T>(string key, string max, string min, long? count = null, long offset = 0) =>
        DeserializeRedisValueTuple1Internal<T, decimal>(ExecuteScalar(key,
            (c, k) => c.Value.ZRevRangeBytesByScoreWithScores(k, max, min, offset, count)));
    ...
    public long ZUnionStore(string destination, decimal[] weights, RedisAggregate aggregate, params string[] keys)
    {
        ...
        if (weights != null && weights.Length != keys.Length)
            throw new Exception("weights 和 keys 参数长度必须相同");
        return NodesNotSupport(new[] {destination}.Concat(keys).ToArray(), 0,
            (c, k) => c.Value.ZUnionStore(k.First(), weights, aggregate, k.Skip(1).ToArray()));
    }
    ...
    public RedisScan<(T member, decimal score)> ZScan<T>(string key, long cursor, string pattern = null, long? count = null)
    {
        ...
        return new RedisScan<(T, decimal)>(scan.Cursor, DeserializeRedisValueTuple1Internal<T, decimal>(scan.Items));
    }
    ...
    public T[] ZRangeByLex<T>(string key, string min, string max, long? count = null, long offset = 0) =>
        DeserializeRedisValueArrayInternal<T>(ExecuteScalar(key, (c, k) => c.Value.ZRangeBytesByLex(k, min, max, offset, count)));
    ...
    /// <param name="max">'(' 表示包含在范围，'[' 表示不包含在范围，'+' 正无穷大，'-' 负无限。 ZRANGEBYLEX zset - + ，命令将返回有序集合中的所有元素</param>
    /// <returns></returns>
    public long ZLexCount(string key, string min, string max) => ExecuteScalar(key, (c, k) => c.Value.ZLexCount(k, min, max));
    ...
    {
        if (members == null || members.Any() == false)
            return 0;
        var args = members.Select(z => SerializeRedisValueInternal(z)).ToArray();
    ...
    public T[] SDiff<T>(params string[] keys) =>
        DeserializeRedisValueArrayInternal<T>(NodesNotSupport(keys, new byte[0][], (c, k) => c.Value.SDiffBytes(k)));
    ...
    public long SDiffStore(string destination, params string[] keys) =>
        NodesNotSupport(new[] {destination}.Concat(keys).ToArray(), 0,
            (c, k) => c.Value.SDiffStore(k.First(), k.Skip(1).ToArray()));
    ...
    public T[] SInter<T>(params string[] keys) =>
        DeserializeRedisValueArrayInternal<T>(NodesNotSupport(keys, new byte[0][], (c, k) => c.Value.SInterBytes(k)));
    ...
    public long SInterStore(string destination, params string[] keys) =>
        NodesNotSupport(new[] {destination}.Concat(keys).ToArray(), 0,
            (c, k) => c.Value.SInterStore(k.First(), k.Skip(1).ToArray()));
    ...
    public T[] SMembers<T>(string key) =>
        DeserializeRedisValueArrayInternal<T>(ExecuteScalar(key, (c, k) => c.Value.SMembersBytes(k)));
    ...
    /// <param name="key">不含prefix前辍</param>
    /// <returns></returns>
    public T SPop<T>(string key) => DeserializeRedisValueInternal<T>(ExecuteScalar(key, (c, k) => c.Value.SPopBytes(k)));
    ...
    public T[] SPop<T>(string key, long count) =>
        DeserializeRedisValueArrayInternal<T>(ExecuteScalar(key, (c, k) => c.Value.SPopBytes(k, count)));
    ...
    public T SRandMember<T>(string key) =>
        DeserializeRedisValueInternal<T>(ExecuteScalar(key, (c, k) => c.Value.SRandMemberBytes(k)));
    ...
    public T[] SRandMembers<T>(string key, int count = 1) =>
        DeserializeRedisValueArrayInternal<T>(ExecuteScalar(key, (c, k) => c.Value.SRandMembersBytes(k, count)));
    ...
    public T[] SUnion<T>(params string[] keys) =>
        DeserializeRedisValueArrayInternal<T>(NodesNotSupport(keys, new byte[0][], (c, k) => c.Value.SUnionBytes(k)));
    ...
    public long SUnionStore(string destination, params string[] keys) =>
        NodesNotSupport(new[] {destination}.Concat(keys).ToArray(), 0,
            (c, k) => c.Value.SUnionStore(k.First(), k.Skip(1).ToArray()));
    ...
    public RedisScan<string> SScan(string key, long cursor, string pattern = null, long? count = null) =>
        ExecuteScalar(key, (c, k) => c.Value.SScan(k, cursor, pattern, count));
    ...
    public RedisScan<T> SScan<T>(string key, long cursor, string pattern = null, long? count = null)
    {
        ...
        return new RedisScan<T>(scan.Cursor, DeserializeRedisValueArrayInternal<T>(scan.Items));
    }
    ...
    public (string key, T value)? BLPopWithKey<T>(int timeout, params string[] keys)
    {
        ...
        if (tuple == null)
            return null;
        return (rkeys?.Where(b => b == tuple.Item1).First() ?? tuple.Item1, DeserializeRedisValueInternal<T>(tuple.Item2));
    }
    ...
    public T BLPop<T>(int timeout, params string[] keys) =>
        DeserializeRedisValueInternal<T>(NodesNotSupport(keys, null, (c, k) => c.Value.BLPopBytes(timeout, k)));
    ...
    public T BRPop<T>(int timeout, params string[] keys) =>
        DeserializeRedisValueInternal<T>(NodesNotSupport(keys, null, (c, k) => c.Value.BRPopBytes(timeout, k)));
    ...
    public string BRPopLPush(string source, string destination, int timeout) =>
        NodesNotSupport(new[] {source, destination}, null, (c, k) => c.Value.BRPopLPush(k.First(), k.Last(), timeout));
    ...
    public T BRPopLPush<T>(string source, string destination, int timeout) =>
        DeserializeRedisValueInternal<T>(NodesNotSupport(new[] {source, destination}, null,
            (c, k) => c.Value.BRPopBytesLPush(k.First(), k.Last(), timeout)));
    ...
    public T LIndex<T>(string key, long index) =>
        DeserializeRedisValueInternal<T>(ExecuteScalar(key, (c, k) => c.Value.LIndexBytes(k, index)));
    ...
    {
        var args = SerializeRedisValueInternal(value);
    ...
    /// <param name="key">不含prefix前辍</param>
    /// <returns></returns>
    public T LPop<T>(string key) => DeserializeRedisValueInternal<T>(ExecuteScalar(key, (c, k) => c.Value.LPopBytes(k)));
    ...
    public long LPush<T>(string key, params T[] value)
    {
        if (value == null || value.Any() == false)
            return 0;
        var args = value.Select(z => SerializeRedisValueInternal(z)).ToArray();
    ...
    public T[] LRange<T>(string key, long start, long stop) =>
        DeserializeRedisValueArrayInternal<T>(ExecuteScalar(key, (c, k) => c.Value.LRangeBytes(k, start, stop)));
    ...
    /// <param name="key">不含prefix前辍</param>
    /// <returns></returns>
    public T RPop<T>(string key) => DeserializeRedisValueInternal<T>(ExecuteScalar(key, (c, k) => c.Value.RPopBytes(k)));
    ...
    public string RPopLPush(string source, string destination) =>
        NodesNotSupport(new[] {source, destination}, null, (c, k) => c.Value.RPopLPush(k.First(), k.Last()));
    ...
    public T RPopLPush<T>(string source, string destination) =>
        DeserializeRedisValueInternal<T>(NodesNotSupport(new[] {source, destination}, null,
            (c, k) => c.Value.RPopBytesLPush(k.First(), k.Last())));
    ...
    public long HDel(string key, params string[] fields) =>
        fields == null || fields.Any() == false ? 0 : ExecuteScalar(key, (c, k) => c.Value.HDel(k, fields));
    ...
    public T HGet<T>(string key, string field) =>
        DeserializeRedisValueInternal<T>(ExecuteScalar(key, (c, k) => c.Value.HGetBytes(k, field)));
    ...
    public Dictionary<string, T> HGetAll<T>(string key) =>
        DeserializeRedisValueDictionaryInternal<string, T>(ExecuteScalar(key, (c, k) => c.Value.HGetAllBytes(k)));
    ...
    public long HIncrBy(string key, string field, long value = 1) =>
        ExecuteScalar(key, (c, k) => c.Value.HIncrBy(k, field, value));
    ...
    public decimal HIncrByFloat(string key, string field, decimal value) =>
        ExecuteScalar(key, (c, k) => c.Value.HIncrByFloat(k, field, value));
    ...
    public string[] HMGet(string key, params string[] fields) =>
        fields == null || fields.Any() == false ? new string[0] : ExecuteScalar(key, (c, k) => c.Value.HMGet(k, fields));
    ...
    public T[] HMGet<T>(string key, params string[] fields) =>
        fields == null || fields.Any() == false
            ? new T[0]
            : DeserializeRedisValueArrayInternal<T>(ExecuteScalar(key, (c, k) => c.Value.HMGetBytes(k, fields)));
    ...
    public bool HMSet(string key, params object[] keyValues)
    {
        ...
        if (keyValues.Length % 2 != 0)
            throw new Exception("keyValues 参数是键值对，不应该出现奇数(数量)，请检查使用姿势。");
        ...
        for (var a = 0; a < keyValues.Length; a += 2)
        {
            ...
            if (string.IsNullOrEmpty(k))
                throw new Exception("keyValues 参数是键值对，并且 key 不可为空");
            parms.Add(k);
            parms.Add(SerializeRedisValueInternal(v));
        }
    ...
    /// <param name="key">不含prefix前辍</param>
    /// <returns></returns>
    public T[] HVals<T>(string key) => DeserializeRedisValueArrayInternal<T>(ExecuteScalar(key, (c, k) => c.Value.HValsBytes(k)));
    ...
    public RedisScan<(string field, T value)> HScan<T>(string key, long cursor, string pattern = null, long? count = null)
    {
        ...
        return new RedisScan<(string, T)>(scan.Cursor,
            scan.Items.Select(z => (z.Item1, DeserializeRedisValueInternal<T>(z.Item2))).ToArray());
    }
    ...
    public long BitOp(RedisBitOp op, string destKey, params string[] keys)
    {
        if (string.IsNullOrEmpty(destKey))
            throw new Exception("destKey 不能为空");
        if (keys == null || keys.Length == 0)
            throw new Exception("keys 不能为空");
        return NodesNotSupport(new[] {destKey}.Concat(keys).ToArray(), 0,
            (c, k) => c.Value.BitOp(op, k.First(), k.Skip(1).ToArray()));
    }
    ...
    public long BitPos(string key, bool bit, long? start = null, long? end = null) =>
        ExecuteScalar(key, (c, k) => c.Value.BitPos(k, bit, start, end));
    ...
    /// <param name="key">不含prefix前辍</param>
    /// <returns></returns>
    public T Get<T>(string key) => DeserializeRedisValueInternal<T>(ExecuteScalar(key, (c, k) => c.Value.GetBytes(k)));
    ...
    public void Get(string key, Stream destination, int bufferSize = 1024)
    {
        ...
        {
            c.Value.WriteNoneRead(new RedisString("GET", k));
            c.Value._reader.ReadBulkBytes(destination, bufferSize);
            return true;
        });
    }
    ...
    public T GetRange<T>(string key, long start, long end) =>
        DeserializeRedisValueInternal<T>(ExecuteScalar(key, (c, k) => c.Value.GetRangeBytes(k, start, end)));
    ...
    {
        var args = SerializeRedisValueInternal(value);
        return DeserializeRedisValueInternal<T>(ExecuteScalar(key, (c, k) => c.Value.GetSetBytes(k, args)));
    }
    ...
    public T[] MGet<T>(params string[] keys) =>
        DeserializeRedisValueArrayInternal<T>(ExecuteArray(keys, (c, k) => c.Value.MGetBytes(k)));
    ...
    internal bool MSetInternal(RedisExistence exists, params object[] keyValues)
    {
        ...
        {
            var k = string.Concat(keyValues[a]);
            var v = SerializeRedisValueInternal(keyValues[a + 1]);
            if (string.IsNullOrEmpty(k))
                throw new Exception("keyValues 参数是键值对，并且 key 不可为空");
        ...
        Func<Object<RedisClient>, string[], long> handle = (c, k) =>
        {
            ...
            if (exists == RedisExistence.Nx)
                return c.Value.MSetNx(parms) ? 1 : 0;
            return c.Value.MSet(parms) == "OK" ? 1 : 0;
        };
        if (exists == RedisExistence.Nx)
            return NodesNotSupport(dic.Keys.ToArray(), 0, handle) > 0;
    ...
    {
        var redisValule = SerializeRedisValueInternal(value);
        if (expireSeconds <= 0 && exists == null)
            return ExecuteScalar(key, (c, k) => c.Value.Set(k, redisValule)) == "OK";
        if (expireSeconds <= 0 && exists != null)
            return ExecuteScalar(key, (c, k) => c.Value.Set(k, redisValule, null, exists)) == "OK";
        if (expireSeconds > 0 && exists == null)
            return ExecuteScalar(key, (c, k) => c.Value.Set(k, redisValule, expireSeconds)) == "OK";
        if (expireSeconds > 0 && exists != null)
            return ExecuteScalar(key, (c, k) => c.Value.Set(k, redisValule, expireSeconds, exists)) == "OK";
        return false;
    }
    ...
    {
        var redisValule = SerializeRedisValueInternal(value);
        if (expire <= TimeSpan.Zero && exists == null)
            return ExecuteScalar(key, (c, k) => c.Value.Set(k, redisValule)) == "OK";
        if (expire <= TimeSpan.Zero && exists != null)
            return ExecuteScalar(key, (c, k) => c.Value.Set(k, redisValule, null, exists)) == "OK";
        if (expire > TimeSpan.Zero && exists == null)
            return ExecuteScalar(key, (c, k) => c.Value.Set(k, redisValule, expire)) == "OK";
        if (expire > TimeSpan.Zero && exists != null)
            return ExecuteScalar(key, (c, k) => c.Value.Set(k, redisValule, expire, exists)) == "OK";
        return false;
    }
    ...
    public string RandomKey() =>
        GetAndExecute(Nodes[NodesIndex[_rnd.Next(0, NodesIndex.Count)]], c =>
        {
            var rk = c.Value.RandomKey();
            var prefix = (c.Pool as RedisClientPool).Prefix;
            if (string.IsNullOrEmpty(prefix) == false && rk.StartsWith(prefix))
                return rk.Substring(prefix.Length);
            return rk;
        });
    ...
    public bool RenameNx(string key, string newKey) =>
        NodesNotSupport(new[] {key, newKey}, false, (c, k) => c.Value.RenameNx(k.First(), k.Last()));
    ...
    public bool Restore(string key, byte[] serializedValue) =>
        ExecuteScalar(key, (c, k) => c.Value.Restore(k, 0, serializedValue)) == "OK";
    ...
    public bool Restore(string key, long ttlMilliseconds, byte[] serializedValue) =>
        ExecuteScalar(key, (c, k) => c.Value.Restore(k, ttlMilliseconds, serializedValue)) == "OK";
    ...
    /// <returns></returns>
    public string[] Sort(string key, long? count = null, long offset = 0, string by = null, RedisSortDir? dir = null,
        bool? isAlpha = null, params string[] get) =>
    ...
    /// <param name="get">根据排序的结果来取出相应的键值</param>
    /// <returns></returns>
    public long SortAndStore(string key, string destination, long? count = null, long offset = 0, string by = null,
        RedisSortDir? dir = null, bool? isAlpha = null, params string[] get) =>
        NodesNotSupport(key,
            (c, k) => c.Value.SortAndStore(k, (c.Pool as RedisClientPool)?.Prefix + destination, offset, count, by, dir, isAlpha,
                get));
    ...
    public KeyType Type(string key) =>
        Enum.TryParse(ExecuteScalar(key, (c, k) => c.Value.Type(k)), true, out KeyType tryenum) ? tryenum : KeyType.None;
    ...
    public RedisScan<string> Scan(long cursor, string pattern = null, long? count = null) =>
        NodesNotSupport("Scan", (c, k) => c.Value.Scan(cursor, pattern, count));
    ...
    public bool GeoAdd(string key, decimal longitude, decimal latitude, object member) =>
        GeoAdd(key, (longitude, latitude, member)) == 1;
    ...
    public long GeoAdd(string key, params (decimal longitude, decimal latitude, object member)[] values)
    {
        if (values == null || values.Any() == false)
            return 0;
        var args = values.Select(z => (z.longitude, z.latitude, SerializeRedisValueInternal(z.member))).ToArray();
    ...
    {
        var args1 = SerializeRedisValueInternal(member1);
        var args2 = SerializeRedisValueInternal(member2);
    ...
    /// <returns></returns>
    public string[] GeoRadius(string key, decimal longitude, decimal latitude, decimal radius, GeoUnit unit = GeoUnit.m,
        long? count = null, GeoOrderBy? sorting = null) =>
        ExecuteScalar(key, (c, k) => c.Value.GeoRadius(k, longitude, latitude, radius, unit, count, sorting))
            .Select(a => a.member).ToArray();
    ...
    /// <param name="sorting">排序</param>
    /// <returns></returns>
    public T[] GeoRadius<T>(string key, decimal longitude, decimal latitude, decimal radius, GeoUnit unit = GeoUnit.m,
        long? count = null, GeoOrderBy? sorting = null) =>
        ExecuteScalar(key, (c, k) => c.Value.GeoRadiusBytes(k, longitude, latitude, radius, unit, count, sorting))
            .Select(a => DeserializeRedisValueInternal<T>(a.member)).ToArray();
    ...
    /// <param name="sorting">排序</param>
    /// <returns></returns>
    public (string member, decimal dist)[] GeoRadiusWithDist(string key, decimal longitude, decimal latitude, decimal radius,
        GeoUnit unit = GeoUnit.m, long? count = null, GeoOrderBy? sorting = null) =>
        ExecuteScalar(key, (c, k) => c.Value.GeoRadius(k, longitude, latitude, radius, unit, count, sorting, false, true))
            .Select(a => (a.member, a.dist)).ToArray();
    ...
    /// <param name="sorting">排序</param>
    /// <returns></returns>
    public (T member, decimal dist)[] GeoRadiusWithDist<T>(string key, decimal longitude, decimal latitude, decimal radius,
        GeoUnit unit = GeoUnit.m, long? count = null, GeoOrderBy? sorting = null) =>
        ExecuteScalar(key, (c, k) => c.Value.GeoRadiusBytes(k, longitude, latitude, radius, unit, count, sorting, false, true))
            .Select(a => (DeserializeRedisValueInternal<T>(a.member), a.dist)).ToArray();
    ...
    /// <param name="sorting">排序</param>
    /// <returns></returns>
    private (string member, decimal longitude, decimal latitude)[] GeoRadiusWithCoord(string key, decimal longitude,
        decimal latitude, decimal radius, GeoUnit unit = GeoUnit.m, long? count = null, GeoOrderBy? sorting = null) =>
        ExecuteScalar(key, (c, k) => c.Value.GeoRadius(k, longitude, latitude, radius, unit, count, sorting, true))
            .Select(a => (a.member, a.longitude, a.latitude)).ToArray();
    ...
    /// <param name="sorting">排序</param>
    /// <returns></returns>
    private (T member, decimal longitude, decimal latitude)[] GeoRadiusWithCoord<T>(string key, decimal longitude,
        decimal latitude, decimal radius, GeoUnit unit = GeoUnit.m, long? count = null, GeoOrderBy? sorting = null) =>
        ExecuteScalar(key, (c, k) => c.Value.GeoRadiusBytes(k, longitude, latitude, radius, unit, count, sorting, true))
            .Select(a => (DeserializeRedisValueInternal<T>(a.member), a.longitude, a.latitude)).ToArray();
    ...
    /// <param name="sorting">排序</param>
    /// <returns></returns>
    public (string member, decimal dist, decimal longitude, decimal latitude)[] GeoRadiusWithDistAndCoord(string key,
        decimal longitude, decimal latitude, decimal radius, GeoUnit unit = GeoUnit.m, long? count = null,
        GeoOrderBy? sorting = null) =>
        ExecuteScalar(key, (c, k) => c.Value.GeoRadius(k, longitude, latitude, radius, unit, count, sorting, true, true))
            .Select(a => (a.member, a.dist, a.longitude, a.latitude)).ToArray();
    ...
    /// <param name="sorting">排序</param>
    /// <returns></returns>
    public (T member, decimal dist, decimal longitude, decimal latitude)[] GeoRadiusWithDistAndCoord<T>(string key,
        decimal longitude, decimal latitude, decimal radius, GeoUnit unit = GeoUnit.m, long? count = null,
        GeoOrderBy? sorting = null) =>
        ExecuteScalar(key, (c, k) => c.Value.GeoRadiusBytes(k, longitude, latitude, radius, unit, count, sorting, true, true))
            .Select(a => (DeserializeRedisValueInternal<T>(a.member), a.dist, a.longitude, a.latitude)).ToArray();
    ...
    /// <param name="sorting">排序</param>
    /// <returns></returns>
    public string[] GeoRadiusByMember(string key, object member, decimal radius, GeoUnit unit = GeoUnit.m, long? count = null,
        GeoOrderBy? sorting = null) =>
        ExecuteScalar(key, (c, k) => c.Value.GeoRadiusByMember(k, member, radius, unit, count, sorting)).Select(a => a.member)
            .ToArray();
    ...
    /// <param name="sorting">排序</param>
    /// <returns></returns>
    public T[] GeoRadiusByMember<T>(string key, object member, decimal radius, GeoUnit unit = GeoUnit.m, long? count = null,
        GeoOrderBy? sorting = null) =>
        DeserializeRedisValueArrayInternal<T>(
            ExecuteScalar(key, (c, k) => c.Value.GeoRadiusBytesByMember(k, member, radius, unit, count, sorting))
                .Select(a => a.member).ToArray());
    ...
    /// <param name="sorting">排序</param>
    /// <returns></returns>
    public (string member, decimal dist)[] GeoRadiusByMemberWithDist(string key, object member, decimal radius,
        GeoUnit unit = GeoUnit.m, long? count = null, GeoOrderBy? sorting = null) =>
        ExecuteScalar(key, (c, k) => c.Value.GeoRadiusByMember(k, member, radius, unit, count, sorting, false, true))
            .Select(a => (a.member, a.dist)).ToArray();
    ...
    /// <param name="sorting">排序</param>
    /// <returns></returns>
    public (T member, decimal dist)[] GeoRadiusByMemberWithDist<T>(string key, object member, decimal radius,
        GeoUnit unit = GeoUnit.m, long? count = null, GeoOrderBy? sorting = null) =>
        ExecuteScalar(key, (c, k) => c.Value.GeoRadiusBytesByMember(k, member, radius, unit, count, sorting, false, true))
            .Select(a => (DeserializeRedisValueInternal<T>(a.member), a.dist)).ToArray();
    ...
    /// <param name="sorting">排序</param>
    /// <returns></returns>
    private (string member, decimal longitude, decimal latitude)[] GeoRadiusByMemberWithCoord(string key, object member,
        decimal radius, GeoUnit unit = GeoUnit.m, long? count = null, GeoOrderBy? sorting = null) =>
        ExecuteScalar(key, (c, k) => c.Value.GeoRadiusByMember(k, member, radius, unit, count, sorting, true))
            .Select(a => (a.member, a.longitude, a.latitude)).ToArray();
    ...
    /// <param name="sorting">排序</param>
    /// <returns></returns>
    private (T member, decimal longitude, decimal latitude)[] GeoRadiusByMemberWithCoord<T>(string key, object member,
        decimal radius, GeoUnit unit = GeoUnit.m, long? count = null, GeoOrderBy? sorting = null) =>
        ExecuteScalar(key, (c, k) => c.Value.GeoRadiusBytesByMember(k, member, radius, unit, count, sorting, true))
            .Select(a => (DeserializeRedisValueInternal<T>(a.member), a.longitude, a.latitude)).ToArray();
    ...
    /// <param name="sorting">排序</param>
    /// <returns></returns>
    public (string member, decimal dist, decimal longitude, decimal latitude)[] GeoRadiusByMemberWithDistAndCoord(string key,
        object member, decimal radius, GeoUnit unit = GeoUnit.m, long? count = null, GeoOrderBy? sorting = null) =>
        ExecuteScalar(key, (c, k) => c.Value.GeoRadiusByMember(k, member, radius, unit, count, sorting, true, true))
            .Select(a => (a.member, a.dist, a.longitude, a.latitude)).ToArray();
    ...
    /// <param name="sorting">排序</param>
    /// <returns></returns>
    public (T member, decimal dist, decimal longitude, decimal latitude)[] GeoRadiusByMemberWithDistAndCoord<T>(string key,
        object member, decimal radius, GeoUnit unit = GeoUnit.m, long? count = null, GeoOrderBy? sorting = null) =>
        ExecuteScalar(key, (c, k) => c.Value.GeoRadiusBytesByMember(k, member, radius, unit, count, sorting, true, true))
            .Select(a => (DeserializeRedisValueInternal<T>(a.member), a.dist, a.longitude, a.latitude)).ToArray();
    ...
    /// <param name="fieldValues">键值对数组</param>
    /// <returns></returns>
    public string XAdd(string key, long maxLen, string id = "*", params (string, string)[] fieldValues) =>
        ExecuteScalar(key, (c, k) => c.Value.XAdd(k, maxLen, id, fieldValues));
    ...
    /// <param name="id">消息id</param>
    /// <returns></returns>
    public (string id, string[] items)[]
        XClaim(string key, string group, string consumer, long minIdleTime, params string[] id) =>
    ...
    /// <returns></returns>
    public (string id, string[] items)[] XClaim(string key, string group, string consumer, long minIdleTime, string[] id,
        long idle, long retryCount, bool force) =>
    ...
    /// <param name="force">在待处理条目列表（PEL）中创建待处理消息条目，即使某些指定的ID尚未在分配给不同客户端的待处理条目列表（PEL）中。但是消息必须存在于流中，否则不存在的消息ID将会被忽略。</param>
    /// <returns>只返回消息id</returns>
    public string[] XClaimJustId(string key, string group, string consumer, long minIdleTime, string[] id, long idle,
        long retryCount, bool force) =>
    ...
    public string XGroupCreate(string key, string group, string id = "$", bool MkStream = false) =>
        ExecuteScalar(key, (c, k) => c.Value.XGroupCreate(k, group, id, MkStream));
    ...
    public string XGroupSetId(string key, string group, string id = "$") =>
        ExecuteScalar(key, (c, k) => c.Value.XGroupSetId(k, group, id));
    ...
    public bool XGroupDelConsumer(string key, string group, string consumer) =>
        ExecuteScalar(key, (c, k) => c.Value.XGroupDelConsumer(k, group, consumer));
    ...
    /// <param name="key">不含prefix前辍</param>
    /// <returns></returns>
    public (long length, long radixTreeKeys, long radixTreeNodes, long groups, string lastGeneratedId, (string id, string[] items)
        firstEntry, (string id, string[] items) lastEntry) XInfoStream(string key) =>
    ...
    /// <param name="group"></param>
    /// <returns></returns>
    public (long count, string minId, string maxId, (string consumer, long count)[] pendings)
        XPending(string key, string group) =>
    ...
    /// <returns></returns>
    public (string id, string consumer, long idle, long transferTimes)[] XPending(string key, string group, string start,
        string end, long count, string consumer = null) =>
    ...
    /// <returns></returns>
    public (string key, (string id, string[] items)[] data)[]
        XRead(long count, long block, params (string key, string id)[] streams) =>
        NodesNotSupport(streams.Select(a => a.key).ToArray(), null,
            (c, k) => c.Value.XRead(count, block, streams.Select((a, i) => (k[i], a.id)).ToArray()));
    ...
    /// <param name="streams">(key,id) 数组</param>
    /// <returns></returns>
    public (string key, (string id, string[] items)[] data)[] XReadGroup(string group, string consumer, long count, long block,
        params (string key, string id)[] streams) =>
        NodesNotSupport(streams.Select(a => a.key).ToArray(), null,
            (c, k) => c.Value.XReadGroup(group, consumer, count, block, streams.Select((a, i) => (k[i], a.id)).ToArray()));
    ...
    public bool BfReserve(string key, decimal errorRate, long capacity, int expansion = 2, bool nonScaling = false) =>
        ExecuteScalar(key, (c, k) => c.Value.Write(RedisCommands.BfReserve(k, errorRate, capacity, expansion, nonScaling))) ==
        "OK";

    public bool BfAdd(string key, object item) =>
        ExecuteScalar(key, (c, k) => c.Value.Write(RedisCommands.BfAdd(k, SerializeRedisValueInternal(item))));

    public bool[] BfMAdd(string key, object[] items) =>
        ExecuteScalar(key,
            (c, k) => c.Value.Write(RedisCommands.BfMAdd(k, items.Select(item => SerializeRedisValueInternal(item)).ToArray())));

    public bool[] BfInsert(string key, object[] items, long? capacity = null, string error = null, int expansion = 2,
        bool noCreate = false, bool nonScaling = false) =>
        ExecuteScalar(key,
            (c, k) => c.Value.Write(RedisCommands.BfInsert(k, items.Select(item => SerializeRedisValueInternal(item)).ToArray(),
                capacity, error, expansion, noCreate, nonScaling)));

    public bool BfExists(string key, object item) =>
        ExecuteScalar(key, (c, k) => c.Value.Write(RedisCommands.BfExists(k, SerializeRedisValueInternal(item))));

    public bool[] BfMExists(string key, object[] items) =>
        ExecuteScalar(key,
            (c, k) => c.Value.Write(RedisCommands.BfMExists(k,
                items.Select(item => SerializeRedisValueInternal(item)).ToArray())));
    ...
    public bool
        CfReserve(string key, long capacity, long? bucketSize = null, long? maxIterations = null, int? expansion = null) =>
        ExecuteScalar(key, (c, k) => c.Value.Write(RedisCommands.CfReserve(k, capacity, bucketSize, maxIterations, expansion))) ==
        "OK";

    public bool CfAdd(string key, object item) =>
        ExecuteScalar(key, (c, k) => c.Value.Write(RedisCommands.CfAdd(false, k, SerializeRedisValueInternal(item))));

    public bool CfAddNx(string key, object item) =>
        ExecuteScalar(key, (c, k) => c.Value.Write(RedisCommands.CfAdd(true, k, SerializeRedisValueInternal(item))));

    public bool[] CfInsert(string key, object[] items, long? capacity = null, bool noCreate = false) =>
        ExecuteScalar(key,
            (c, k) => c.Value.Write(RedisCommands.CfInsert(false, k,
                items.Select(item => SerializeRedisValueInternal(item)).ToArray(), capacity, noCreate)));

    public bool[] CfInsertNx(string key, object[] items, long? capacity = null, bool noCreate = false) =>
        ExecuteScalar(key,
            (c, k) => c.Value.Write(RedisCommands.CfInsert(true, k,
                items.Select(item => SerializeRedisValueInternal(item)).ToArray(), capacity, noCreate)));

    public bool CfExists(string key, object item) =>
        ExecuteScalar(key, (c, k) => c.Value.Write(RedisCommands.CfExists(k, SerializeRedisValueInternal(item))));

    public bool CfDel(string key, object item) =>
        ExecuteScalar(key, (c, k) => c.Value.Write(RedisCommands.CfDel(k, SerializeRedisValueInternal(item))));

    public long CfCount(string key, object item) =>
        ExecuteScalar(key, (c, k) => c.Value.Write(RedisCommands.CfCount(k, SerializeRedisValueInternal(item))));
    ...
    public (long size, long numberOfBuckets, long numberOfFilter, long numberOfItemsInserted, long numberOfItemsDeleted, long
        bucketSize, long expansionRate, long maxIteration) CfInfo(string key) =>
    ...
    public long[] CmsIncrBy(string key, params (object item, long increment)[] items) =>
        ExecuteScalar(key,
            (c, k) => c.Value.Write(RedisCommands.CmsIncrBy(k,
                items.Select(item => (SerializeRedisValueInternal(item.item), item.increment)).ToArray())));

    public long[] CmsQuery(string key, params object[] items) =>
        ExecuteScalar(key,
            (c, k) => c.Value.Write(RedisCommands.CmsQuery(k,
                items.Select(item => SerializeRedisValueInternal(item)).ToArray())));

    public bool CmsMerge(string dest, long numKeys, string[] src, long[] weights) =>
        NodesNotSupport(new[] {dest}.Concat(src).ToArray(), null,
            (c, k) => c.Value.Write(RedisCommands.CmsMerge(k.FirstOrDefault(), numKeys, k.Where((_, idx) => idx > 0).ToArray(),
                weights))) == "OK";
    ...
    public string[] TopkAdd(string key, object[] items) =>
        ExecuteScalar(key,
            (c, k) => c.Value.Write(RedisCommands.TopkAdd(k, items.Select(item => SerializeRedisValueInternal(item)).ToArray())));

    public string[] TopkIncrBy(string key, params (object item, long increment)[] items) =>
        ExecuteScalar(key,
            (c, k) => c.Value.Write(RedisCommands.TopkIncrBy(k,
                items.Select(item => (SerializeRedisValueInternal(item.item), item.increment)).ToArray())));

    public bool[] TopkQuery(string key, object[] items) =>
        ExecuteScalar(key,
            (c, k) => c.Value.Write(RedisCommands.TopkQuery(k,
                items.Select(item => SerializeRedisValueInternal(item)).ToArray())));

    public long[] TopkCount(string key, object[] items) =>
        ExecuteScalar(key,
            (c, k) => c.Value.Write(RedisCommands.TopkCount(k,
                items.Select(item => SerializeRedisValueInternal(item)).ToArray())));

    public string[] TopkList(string key) => ExecuteScalar(key, (c, k) => c.Value.Write(RedisCommands.TopkList(k)));
    ...
    public CSRedisClientLock Lock(string name, int timeoutSeconds, bool autoDelay = true)
    {
        ...
        while (DateTime.Now.Subtract(startTime).TotalSeconds < timeoutSeconds)
        {
            ...
            if (Set(name, value, timeoutSeconds, RedisExistence.Nx))
            {
...
public class CSRedisClientLock : IDisposable
{
    ...
    public CSRedisClientLock(CSRedisClient rds, string name, string value, int timeoutSeconds, double refreshSeconds,
        bool autoDelay)
    {
        _client = rds;
        _name = name;
