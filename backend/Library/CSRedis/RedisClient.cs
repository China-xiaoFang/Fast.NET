...
public partial class RedisClient : IRedisClientSync, IRedisClientAsync
{
    ...
    public int ReceiveTimeout
    {
        get
        {
            return _connector.ReceiveTimeout;
        }
        set
        {
            _connector.ReceiveTimeout = value;
        }
    }
    ...
    public int SendTimeout
    {
        get
        {
            return _connector.SendTimeout;
        }
        set
        {
            _connector.SendTimeout = value;
        }
    }
    ...
    public int ReconnectAttempts
    {
        get
        {
            return _connector.ReconnectAttempts;
        }
        set
        {
            _connector.ReconnectAttempts = value;
        }
    }
    ...
    public int ReconnectWait
    {
        get
        {
            return _connector.ReconnectWait;
        }
        set
        {
            _connector.ReconnectWait = value;
        }
    }
    ...
    public RedisClient(string host) : this(host, DefaultPort)
    {
    }
    ...
    public RedisClient(string host, int port) : this(host, port, DefaultSSL)
    {
    }
    ...
    public RedisClient(string host, int port, bool ssl) : this(host, port, ssl, DefaultConcurrency, DefaultBufferSize)
    {
    }
    ...
    public RedisClient(EndPoint endpoint) : this(endpoint, DefaultSSL)
    {
    }
    ...
    /// <param name="endpoint">Redis server</param>
    /// <param name="ssl">Set to true if remote Redis server expects SSL</param>
    public RedisClient(EndPoint endpoint, bool ssl) : this(endpoint, ssl, DefaultConcurrency, DefaultBufferSize)
    {
    }
    ...
    public RedisClient(string host, int port, int asyncConcurrency, int asyncBufferSize) : this(host, port, DefaultSSL,
        asyncConcurrency, asyncBufferSize)
    {
    }
    ...
    /// <param name="asyncConcurrency">Max concurrent threads (default 1000)</param>
    /// <param name="asyncBufferSize">Async thread buffer size (default 10240 bytes)</param>
    public RedisClient(string host, int port, bool ssl, int asyncConcurrency, int asyncBufferSize) : this(
        new DnsEndPoint(host, port), ssl, asyncConcurrency, asyncBufferSize)
    {
    }
    ...
    /// <param name="asyncConcurrency">Max concurrent threads (default 1000)</param>
    /// <param name="asyncBufferSize">Async thread buffer size (default 10240 bytes)</param>
    public RedisClient(EndPoint endpoint, int asyncConcurrency, int asyncBufferSize) : this(endpoint, DefaultSSL,
        asyncConcurrency, asyncBufferSize)
    {
    }
    ...
    /// <param name="asyncConcurrency">Max concurrent threads (default 1000)</param>
    /// <param name="asyncBufferSize">Async thread buffer size (default 10240 bytes)</param>
    public RedisClient(EndPoint endpoint, bool ssl, int asyncConcurrency, int asyncBufferSize) : this(new RedisSocket(ssl),
        endpoint, asyncConcurrency, asyncBufferSize)
    {
    }

    internal RedisClient(IRedisSocket socket, EndPoint endpoint) : this(socket, endpoint, DefaultConcurrency, DefaultBufferSize)
    {
    }
