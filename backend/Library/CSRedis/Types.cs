...
public class RedisMasterRole : RedisRole
{
    ...
    /// </summary>
    public Tuple<string, int, long>[] Slaves { get; }

    internal RedisMasterRole(string role, long replicationOffset, Tuple<string, int, long>[] slaves) : base(role)
    {
...
public class RedisSlaveRole : RedisRole
{
    ...
    internal RedisSlaveRole(string role, string masterIp, int masterPort, string replicationState, long dataReceived) : base(role)
    {
        MasterIp = masterIp;
...
public class RedisSentinelRole : RedisRole
{
    ...
    internal RedisSentinelRole(string role, string[] masters) : base(role)
    {
        Masters = masters;
    }
}
...
public class RedisSubscriptionChannel : RedisSubscriptionResponse
{
    ...
    internal RedisSubscriptionChannel(string type, string channel, string pattern, long count) : base(type, channel, pattern)
    {
        Count = count;
    }
}
...
public class RedisSubscriptionMessage : RedisSubscriptionResponse
{
    ...
    internal RedisSubscriptionMessage(string type, string channel, string body) : base(type, channel, null)
    {
        Body = body;
    }

    internal RedisSubscriptionMessage(string type, string pattern, string channel, string body) : base(type, channel, pattern)
    {
        Body = body;
    }
}
...
public abstract class RedisMasterSlaveInfo : RedisServerInfo
{
    ...
    /// <param name="info">Serialization info</param>
    /// <param name="context">Serialization context</param>
    public RedisMasterSlaveInfo(SerializationInfo info, StreamingContext context) : base(info, context)
    {
...
public class RedisMasterInfo : RedisMasterSlaveInfo
{
    ...
    /// <param name="info">Serialization info</param>
    /// <param name="context">Serialization context</param>
    public RedisMasterInfo(SerializationInfo info, StreamingContext context) : base(info, context)
    {
...
public class RedisSlaveInfo : RedisMasterSlaveInfo
{
    ...
    /// <param name="info">Serialization info</param>
    /// <param name="context">Serialization context</param>
    public RedisSlaveInfo(SerializationInfo info, StreamingContext context) : base(info, context)
    {
...
public class RedisSentinelInfo : RedisServerInfo
{
    ...
    public RedisSentinelInfo(SerializationInfo info, StreamingContext context) : base(info, context)
    {
        ...
        if (SDownTime == 0)
            SDownTime = -1;
        if (LastHelloMessage == 0)
            LastHelloMessage = -1;
        if (VotedLeaderEpoch == 0)
            VotedLeaderEpoch = -1;
    }
