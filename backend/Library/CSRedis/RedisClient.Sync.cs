...
public partial class RedisClient
{
    ...
    public string[] Sort(string key, long? offset = null, long? count = 0, string by = null, RedisSortDir? dir = null,
    ...
    public long SortAndStore(string key, string destination, long? offset = null, long? count = 0, string by = null,
        RedisSortDir? dir = null, bool? isAlpha = false, params string[] get)
    {
    ...
    public T HGetAll<T>(string key) where T : class
    {
    ...
    /// <returns>Status code</returns>
    public string HMSet<T>(string key, T obj) where T : class
    {
    ...
    public string[] ZRangeByScore(string key, decimal min, decimal max, bool withScores = false, bool exclusiveMin = false,
        bool exclusiveMax = false, long? offset = null, long? count = null)
    {
        return Write(RedisCommands.ZRangeByScore(key, min, max, withScores, exclusiveMin, exclusiveMax, offset, count));
    }

    public byte[][] ZRangeBytesByScore(string key, decimal min, decimal max, bool withScores = false, bool exclusiveMin = false,
        bool exclusiveMax = false, long? offset = null, long? count = null)
    {
    ...
    /// <param name="count">Number of elements to return</param>
    /// <returns>List of elements in the specified range (with optional scores)</returns>
    public string[] ZRangeByScore(string key, string min, string max, bool withScores = false, long? offset = null,
        long? count = null)
    {
        return Write(RedisCommands.ZRangeByScore(key, min, max, withScores, offset, count));
    }

    public byte[][] ZRangeBytesByScore(string key, string min, string max, bool withScores = false, long? offset = null,
        long? count = null)
    {
    ...
    /// <param name="count">Number of elements to return</param>
    /// <returns>List of elements in the specified range (with optional scores)</returns>
    public Tuple<string, decimal>[] ZRangeByScoreWithScores(string key, decimal min, decimal max, bool exclusiveMin = false,
        bool exclusiveMax = false, long? offset = null, long? count = null)
    {
        return Write(RedisCommands.ZRangeByScoreWithScores(key, min, max, exclusiveMin, exclusiveMax, offset, count));
    }

    public Tuple<byte[], decimal>[] ZRangeBytesByScoreWithScores(string key, decimal min, decimal max, bool exclusiveMin = false,
        bool exclusiveMax = false, long? offset = null, long? count = null)
    {
    ...
    /// <param name="count">Number of elements to return</param>
    /// <returns>List of elements in the specified range (with optional scores)</returns>
    public Tuple<string, decimal>[] ZRangeByScoreWithScores(string key, string min, string max, long? offset = null,
        long? count = null)
    {
        return Write(RedisCommands.ZRangeByScoreWithScores(key, min, max, offset, count));
    }

    public Tuple<byte[], decimal>[] ZRangeBytesByScoreWithScores(string key, string min, string max, long? offset = null,
        long? count = null)
    {
    ...
    public string[] ZRevRangeByScore(string key, decimal max, decimal min, bool withScores = false, bool exclusiveMax = false,
        bool exclusiveMin = false, long? offset = null, long? count = null)
    {
        return Write(RedisCommands.ZRevRangeByScore(key, max, min, withScores, exclusiveMax, exclusiveMin, offset, count));
    }

    public byte[][] ZRevRangeBytesByScore(string key, decimal max, decimal min, bool withScores = false,
    ...
    /// <param name="count">Number of elements to return</param>
    /// <returns>List of elements in the specified score range (with optional scores)</returns>
    public string[] ZRevRangeByScore(string key, string max, string min, bool withScores = false, long? offset = null,
        long? count = null)
    {
        return Write(RedisCommands.ZRevRangeByScore(key, max, min, withScores, offset, count));
    }

    public byte[][] ZRevRangeBytesByScore(string key, string max, string min, bool withScores = false, long? offset = null,
        long? count = null)
    {
    ...
    /// <param name="count">Number of elements to return</param>
    /// <returns>List of elements in the specified score range (with optional scores)</returns>
    public Tuple<string, decimal>[] ZRevRangeByScoreWithScores(string key, decimal max, decimal min, bool exclusiveMax = false,
        bool exclusiveMin = false, long? offset = null, long? count = null)
    {
        return Write(RedisCommands.ZRevRangeByScoreWithScores(key, max, min, exclusiveMax, exclusiveMin, offset, count));
    }

    public Tuple<byte[], decimal>[] ZRevRangeBytesByScoreWithScores(string key, decimal max, decimal min,
        bool exclusiveMax = false, bool exclusiveMin = false, long? offset = null, long? count = null)
    {
    ...
    /// <param name="count">Number of elements to return</param>
    /// <returns>List of elements in the specified score range (with optional scores)</returns>
    public Tuple<string, decimal>[] ZRevRangeByScoreWithScores(string key, string max, string min, long? offset = null,
        long? count = null)
    {
        return Write(RedisCommands.ZRevRangeByScoreWithScores(key, max, min, offset, count));
    }

    public Tuple<byte[], decimal>[] ZRevRangeBytesByScoreWithScores(string key, string max, string min, long? offset = null,
        long? count = null)
    {
    ...
    {
        var response = _transaction.Abort();
    ...
    public long GeoAdd(string key, params (decimal longitude, decimal latitude, object member)[] values)
    {
        if (values == null || values.Length == 0)
            throw new Exception("values 参数不能为空");
        var args = new List<object>();
        args.Add(key);
        foreach (var v in values)
            args.AddRange(new[] {v.longitude, v.latitude, v.member});
    ...
    {
        if (unit == GeoUnit.m)
            return Write(new RedisFloat.Nullable("GEODIST", key, member1, member2));
    ...
    public (decimal longitude, decimal latitude)?[] GeoPos(string key, object[] members)
    {
        ...
        args.AddRange(members);
        var ret = Write(
            new RedisArray.Generic<decimal[]>(new RedisArray.Generic<decimal>(new RedisFloat("GEOPOS", args.ToArray()))));
        return ret.Select(a => a != null && a.Length == 2 ? new (decimal, decimal)?((a[0], a[1])) : null).ToArray();
    }

    public (string member, decimal dist, decimal longitude, decimal latitude, long hash)[] GeoRadius(string key,
        decimal longitude, decimal latitude, decimal radius, GeoUnit unit = GeoUnit.m, long? count = null,
        GeoOrderBy? sorting = null, bool withCoord = false, bool withDist = false, bool withHash = false)
    {
        ...
        var cmd = new RedisTuple.Generic<string, decimal, long, decimal[]>.Single(new RedisString(null),
            withDist == false ? null : new RedisFloat(null), withHash == false ? null : new RedisInt(null),
        ...
        return ret.Select(a => (a.Item1, a.Item2, a.Item4 == null ? default(decimal) : a.Item4[0],
            a.Item4 == null ? default(decimal) : a.Item4[1], a.Item3)).ToArray();
    }

    public (byte[] member, decimal dist, decimal longitude, decimal latitude, long hash)[] GeoRadiusBytes(string key,
        decimal longitude, decimal latitude, decimal radius, GeoUnit unit = GeoUnit.m, long? count = null,
        GeoOrderBy? sorting = null, bool withCoord = false, bool withDist = false, bool withHash = false)
    {
        var args = new List<object>(new object[] {key, longitude, latitude, radius, unit});
        ...
        var cmd = new RedisTuple.Generic<byte[], decimal, long, decimal[]>.Single(new RedisBytes(null),
            withDist == false ? null : new RedisFloat(null), withHash == false ? null : new RedisInt(null),
            withCoord == false ? null : new RedisArray.Generic<decimal>(new RedisFloat(null)), "GEORADIUS", args.ToArray());
    ...
    public (string member, decimal dist, decimal longitude, decimal latitude, long hash)[] GeoRadiusByMember(string key,
        object member, decimal radius, GeoUnit unit = GeoUnit.m, long? count = null, GeoOrderBy? sorting = null,
        bool withCoord = false, bool withDist = false, bool withHash = false)
    {
        var args = new List<object>(new[] {key, member, radius, unit});
        if (withCoord)
            args.Add("WITHCOORD");
        if (withDist)
            args.Add("WITHDIST");
        ...
        var cmd = new RedisTuple.Generic<string, decimal, long, decimal[]>.Single(new RedisString(null),
            withDist == false ? null : new RedisFloat(null), withHash == false ? null : new RedisInt(null),
            withCoord == false ? null : new RedisArray.Generic<decimal>(new RedisFloat(null)), "GEORADIUSBYMEMBER",
            args.ToArray());
        var ret = Write(new RedisArray.Generic<Tuple<string, decimal, long, decimal[]>>(cmd));
        return ret.Select(a => (a.Item1, a.Item2, a.Item4 == null ? default(decimal) : a.Item4[0],
            a.Item4 == null ? default(decimal) : a.Item4[1], a.Item3)).ToArray();
    ...
    public (byte[] member, decimal dist, decimal longitude, decimal latitude, long hash)[] GeoRadiusBytesByMember(string key,
        object member, decimal radius, GeoUnit unit = GeoUnit.m, long? count = null, GeoOrderBy? sorting = null,
        bool withCoord = false, bool withDist = false, bool withHash = false)
    {
        var args = new List<object>(new[] {key, member, radius, unit});
    ...
    public string XAdd(string key, long maxLen, string id = "*", params (string, string)[] fieldValues) =>
        Write(RedisCommands.XAdd(key, maxLen, id, fieldValues));
    ...
    public string XGroupCreate(string key, string group, string id = "$", bool MkStream = false) =>
        Write(RedisCommands.XGroup.Create(key, group, id, MkStream));
    ...
    public bool XGroupDelConsumer(string key, string group, string consumer) =>
        Write(RedisCommands.XGroup.DelConsumer(key, group, consumer));
    ...
    public (long count, string minId, string maxId, (string consumer, long count)[] pendings)
        ...
        Write(RedisCommands.XPending(key, group));

    public (string id, string consumer, long millisecond, long transferTimes)[] XPending(string key, string group, string start,
        string end, long count, string consumer = null) =>
        Write(RedisCommands.XPending(key, group, start, end, count, consumer));

    public (string id, string[] items)[] XRange(string key, string start, string end, long count = 1) =>
        Write(RedisCommands.XRange(key, start, end, count));

    public (string id, string[] items)[] XRevRange(string key, string end, string start, long count = 1) =>
        Write(RedisCommands.XRevRange(key, end, start, count));

    public (string key, (string id, string[] items)[] data)[] XRead(long count, long block,
