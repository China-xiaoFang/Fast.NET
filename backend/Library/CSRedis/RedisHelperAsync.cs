...
partial class RedisHelper<TMark>
{
    ...
    public static Task<T> CacheShellAsync<T>(string key, int timeoutSeconds, Func<Task<T>> getDataAsync) =>
        Instance.CacheShellAsync(key, timeoutSeconds, getDataAsync);
    ...
    public static Task<T> CacheShellAsync<T>(string key, string field, int timeoutSeconds, Func<Task<T>> getDataAsync) =>
        Instance.CacheShellAsync(key, field, timeoutSeconds, getDataAsync);
    ...
    /// <returns></returns>
    public static Task<(string key, T value)[]> CacheShellAsync<T>(string key, string[] fields, int timeoutSeconds,
        Func<string[], Task<(string, T)[]>> getDataAsync) =>
        Instance.CacheShellAsync(key, fields, timeoutSeconds, getDataAsync);
    ...
    /// <returns></returns>
    public static Task<object> EvalAsync(string script, string key, params object[] args) =>
        Instance.EvalAsync(script, key, args);
    ...
    /// <param name="args">参数</param>
    /// <returns></returns>
    public static Task<object> EvalSHAAsync(string sha1, string key, params object[] args) =>
        Instance.EvalSHAAsync(sha1, key, args);
    ...
    /// <param name="message">消息文本</param>
    /// <returns></returns>
    public static Task<long> PublishNoneMessageIdAsync(string channel, string message) =>
        Instance.PublishNoneMessageIdAsync(channel, message);
    ...
    public static Task<Dictionary<string, long>> PubSubNumSubAsync(params string[] channels) =>
        Instance.PubSubNumSubAsync(channels);
    ...
    /// <returns></returns>
    [Obsolete("分区模式下，若keys分散在多个分区节点时，将报错")]
    public static Task<bool> PfMergeAsync(string destKey, params string[] sourceKeys) =>
        Instance.PfMergeAsync(destKey, sourceKeys);
    ...
    /// <returns></returns>
    public static Task<long> ZAddAsync(string key, params (decimal, object)[] scoreMembers) =>
        Instance.ZAddAsync(key, scoreMembers);
    ...
    /// <returns></returns>
    public static Task<decimal> ZIncrByAsync(string key, string member, decimal increment = 1) =>
        Instance.ZIncrByAsync(key, member, increment);
    ...
    /// <returns></returns>
    public static Task<long> ZInterStoreAsync(string destination, decimal[] weights, RedisAggregate aggregate,
        params string[] keys) =>
        Instance.ZInterStoreAsync(destination, weights, aggregate, keys);
    ...
    /// <param name="stop">结束位置，0表示第一个元素，-1表示最后一个元素</param>
    /// <returns></returns>
    public static Task<(string member, decimal score)[]> ZRangeWithScoresAsync(string key, long start, long stop) =>
        Instance.ZRangeWithScoresAsync(key, start, stop);
    ...
    /// <param name="stop">结束位置，0表示第一个元素，-1表示最后一个元素</param>
    /// <returns></returns>
    public static Task<(T member, decimal score)[]> ZRangeWithScoresAsync<T>(string key, long start, long stop) =>
        Instance.ZRangeWithScoresAsync<T>(key, start, stop);
    ...
    /// <returns></returns>
    public static Task<string[]> ZRangeByScoreAsync(string key, decimal min, decimal max, long? limit = null, long offset = 0) =>
        Instance.ZRangeByScoreAsync(key, min, max, limit, offset);
    ...
    /// <param name="offset">返回条件偏移位置</param>
    /// <returns></returns>
    public static Task<T[]> ZRangeByScoreAsync<T>(string key, decimal min, decimal max, long? limit = null, long offset = 0) =>
        Instance.ZRangeByScoreAsync<T>(key, min, max, limit, offset);
    ...
    /// <param name="offset">返回条件偏移位置</param>
    /// <returns></returns>
    public static Task<string[]> ZRangeByScoreAsync(string key, string min, string max, long? limit = null, long offset = 0) =>
        Instance.ZRangeByScoreAsync(key, min, max, limit, offset);
    ...
    /// <param name="offset">返回条件偏移位置</param>
    /// <returns></returns>
    public static Task<T[]> ZRangeByScoreAsync<T>(string key, string min, string max, long? limit = null, long offset = 0) =>
        Instance.ZRangeByScoreAsync<T>(key, min, max, limit, offset);
    ...
    /// <param name="offset">返回条件偏移位置</param>
    /// <returns></returns>
    public static Task<(string member, decimal score)[]> ZRangeByScoreWithScoresAsync(string key, decimal min, decimal max,
    ...
    /// <param name="offset">返回条件偏移位置</param>
    /// <returns></returns>
    public static Task<(T member, decimal score)[]> ZRangeByScoreWithScoresAsync<T>(string key, decimal min, decimal max,
        long? limit = null, long offset = 0) =>
    ...
    /// <param name="offset">返回条件偏移位置</param>
    /// <returns></returns>
    public static Task<(string member, decimal score)[]> ZRangeByScoreWithScoresAsync(string key, string min, string max,
        long? limit = null, long offset = 0) =>
        Instance.ZRangeByScoreWithScoresAsync(key, min, max, limit, offset);
    ...
    /// <param name="offset">返回条件偏移位置</param>
    /// <returns></returns>
    public static Task<(T member, decimal score)[]> ZRangeByScoreWithScoresAsync<T>(string key, string min, string max,
        long? limit = null, long offset = 0) =>
        Instance.ZRangeByScoreWithScoresAsync<T>(key, min, max, limit, offset);
    ...
    /// <param name="stop">结束位置，0表示第一个元素，-1表示最后一个元素</param>
    /// <returns></returns>
    public static Task<long> ZRemRangeByRankAsync(string key, long start, long stop) =>
        Instance.ZRemRangeByRankAsync(key, start, stop);
    ...
    /// <param name="max">分数最大值 decimal.MaxValue 10</param>
    /// <returns></returns>
    public static Task<long> ZRemRangeByScoreAsync(string key, decimal min, decimal max) =>
        Instance.ZRemRangeByScoreAsync(key, min, max);
    ...
    /// <param name="max">分数最大值 +inf (10 10</param>
    /// <returns></returns>
    public static Task<long> ZRemRangeByScoreAsync(string key, string min, string max) =>
        Instance.ZRemRangeByScoreAsync(key, min, max);
    ...
    /// <param name="stop">结束位置，0表示第一个元素，-1表示最后一个元素</param>
    /// <returns></returns>
    public static Task<(string member, decimal score)[]> ZRevRangeWithScoresAsync(string key, long start, long stop) =>
        Instance.ZRevRangeWithScoresAsync(key, start, stop);
    ...
    /// <param name="stop">结束位置，0表示第一个元素，-1表示最后一个元素</param>
    /// <returns></returns>
    public static Task<(T member, decimal score)[]> ZRevRangeWithScoresAsync<T>(string key, long start, long stop) =>
        Instance.ZRevRangeWithScoresAsync<T>(key, start, stop);
    ...
    public static Task<string[]>
        ZRevRangeByScoreAsync(string key, decimal max, decimal min, long? limit = null, long? offset = 0) =>
        Instance.ZRevRangeByScoreAsync(key, max, min, limit, offset);
    ...
    /// <param name="offset">返回条件偏移位置</param>
    /// <returns></returns>
    public static Task<T[]> ZRevRangeByScoreAsync<T>(string key, decimal max, decimal min, long? limit = null, long offset = 0) =>
        Instance.ZRevRangeByScoreAsync<T>(key, max, min, limit, offset);
    ...
    /// <returns></returns>
    public static Task<string[]>
        ZRevRangeByScoreAsync(string key, string max, string min, long? limit = null, long? offset = 0) =>
        Instance.ZRevRangeByScoreAsync(key, max, min, limit, offset);
    ...
    /// <param name="offset">返回条件偏移位置</param>
    /// <returns></returns>
    public static Task<T[]> ZRevRangeByScoreAsync<T>(string key, string max, string min, long? limit = null, long offset = 0) =>
        Instance.ZRevRangeByScoreAsync<T>(key, max, min, limit, offset);
    ...
    /// <param name="offset">返回条件偏移位置</param>
    /// <returns></returns>
    public static Task<(string member, decimal score)[]> ZRevRangeByScoreWithScoresAsync(string key, decimal max, decimal min,
        long? limit = null, long offset = 0) =>
    ...
    /// <param name="offset">返回条件偏移位置</param>
    /// <returns></returns>
    public static Task<(T member, decimal score)[]> ZRevRangeByScoreWithScoresAsync<T>(string key, decimal max, decimal min,
        long? limit = null, long offset = 0) =>
    ...
    /// <param name="offset">返回条件偏移位置</param>
    /// <returns></returns>
    public static Task<(string member, decimal score)[]> ZRevRangeByScoreWithScoresAsync(string key, string max, string min,
        long? limit = null, long offset = 0) =>
        Instance.ZRevRangeByScoreWithScoresAsync(key, max, min, limit, offset);
    ...
    /// <param name="offset">返回条件偏移位置</param>
    /// <returns></returns>
    public static Task<(T member, decimal score)[]> ZRevRangeByScoreWithScoresAsync<T>(string key, string max, string min,
        long? limit = null, long offset = 0) =>
        Instance.ZRevRangeByScoreWithScoresAsync<T>(key, max, min, limit, offset);
    ...
    /// <param name="keys">一个或多个有序集合，不含prefix前辍</param>
    /// <returns></returns>
    public static Task<long> ZUnionStoreAsync(string destination, decimal[] weights, RedisAggregate aggregate,
        params string[] keys) =>
        Instance.ZUnionStoreAsync(destination, weights, aggregate, keys);
    ...
    /// <returns></returns>
    public static Task<RedisScan<(string member, decimal score)>> ZScanAsync(string key, long cursor, string pattern = null,
        long? count = null) =>
    ...
    /// <param name="count">数量</param>
    /// <returns></returns>
    public static Task<RedisScan<(T member, decimal score)>> ZScanAsync<T>(string key, long cursor, string pattern = null,
        long? count = null) =>
    ...
    /// <param name="max">'(' 表示包含在范围，'[' 表示不包含在范围，'+' 正无穷大，'-' 负无限。 ZRANGEBYLEX zset - + ，命令将返回有序集合中的所有元素</param>
    /// <returns></returns>
    public static Task<long> ZLexCountAsync(string key, string min, string max) => Instance.ZLexCountAsync(key, min, max);
    ...
    /// <returns></returns>
    public static Task<long> SDiffStoreAsync(string destination, params string[] keys) =>
        Instance.SDiffStoreAsync(destination, keys);
    ...
    /// <param name="keys">一个或多个无序集合，不含prefix前辍</param>
    /// <returns></returns>
    public static Task<long> SInterStoreAsync(string destination, params string[] keys) =>
        Instance.SInterStoreAsync(destination, keys);
    ...
    /// <param name="member">成员</param>
    /// <returns></returns>
    public static Task<bool> SMoveAsync(string source, string destination, object member) =>
        Instance.SMoveAsync(source, destination, member);
    ...
    /// <param name="keys">一个或多个无序集合，不含prefix前辍</param>
    /// <returns></returns>
    public static Task<long> SUnionStoreAsync(string destination, params string[] keys) =>
        Instance.SUnionStoreAsync(destination, keys);
    ...
    /// <param name="count">数量</param>
    /// <returns></returns>
    public static Task<RedisScan<string>> SScanAsync(string key, long cursor, string pattern = null, long? count = null) =>
        Instance.SScanAsync(key, cursor, pattern, count);
    ...
    /// <param name="count">数量</param>
    /// <returns></returns>
    public static Task<RedisScan<T>> SScanAsync<T>(string key, long cursor, string pattern = null, long? count = null) =>
        Instance.SScanAsync<T>(key, cursor, pattern, count);
    ...
    /// <returns></returns>
    public static Task<long> LInsertBeforeAsync(string key, object pivot, object value) =>
        Instance.LInsertBeforeAsync(key, pivot, value);
    ...
    /// <param name="value">新元素</param>
    /// <returns></returns>
    public static Task<long> LInsertAfterAsync(string key, object pivot, object value) =>
        Instance.LInsertAfterAsync(key, pivot, value);
    ...
    /// <param name="value">增量值(默认=1)</param>
    /// <returns></returns>
    public static Task<decimal> HIncrByFloatAsync(string key, string field, decimal value = 1) =>
        Instance.HIncrByFloatAsync(key, field, value);
    ...
    /// <param name="count">数量</param>
    /// <returns></returns>
    public static Task<RedisScan<(string field, string value)>> HScanAsync(string key, long cursor, string pattern = null,
        long? count = null) =>
    ...
    /// <param name="count">数量</param>
    /// <returns></returns>
    public static Task<RedisScan<(string field, T value)>> HScanAsync<T>(string key, long cursor, string pattern = null,
        long? count = null) =>
    ...
    public static Task<long> BitOpAsync(RedisBitOp op, string destKey, params string[] keys) =>
        Instance.BitOpAsync(op, destKey, keys);
    ...
    public static Task<long> BitPosAsync(string key, bool bit, long? start = null, long? end = null) =>
        Instance.BitPosAsync(key, bit, start, end);
    ...
    public static Task<bool> SetAsync(string key, object value, int expireSeconds = -1, RedisExistence? exists = null) =>
        Instance.SetAsync(key, value, expireSeconds, exists);

    public static Task<bool> SetAsync(string key, object value, TimeSpan expire, RedisExistence? exists = null) =>
        Instance.SetAsync(key, value, expire, exists);
    ...
    /// <param name="serializedValue">序列化值</param>
    /// <returns></returns>
    public static Task<bool> RestoreAsync(string key, long ttlMilliseconds, byte[] serializedValue) =>
        Instance.RestoreAsync(key, ttlMilliseconds, serializedValue);
    ...
    /// <returns></returns>
    public static Task<string[]> SortAsync(string key, long? count = null, long offset = 0, string by = null,
    ...
    /// <param name="get">根据排序的结果来取出相应的键值</param>
    /// <returns></returns>
    public static Task<long> SortAndStoreAsync(string key, string destination, long? count = null, long offset = 0,
    ...
    /// <param name="count">数量</param>
    /// <returns></returns>
    public static Task<RedisScan<string>> ScanAsync(long cursor, string pattern = null, long? count = null) =>
        Instance.ScanAsync(cursor, pattern, count);
    ...
    /// <param name="count">数量</param>
    /// <returns></returns>
    public static Task<RedisScan<T>> ScanAsync<T>(long cursor, string pattern = null, long? count = null) =>
        Instance.ScanAsync<T>(cursor, pattern, count);
    ...
    public static Task<bool> GeoAddAsync(string key, decimal longitude, decimal latitude, object member) =>
        Instance.GeoAddAsync(key, longitude, latitude, member);
    ...
    public static Task<long> GeoAddAsync(string key, params (decimal longitude, decimal latitude, object member)[] values) =>
        Instance.GeoAddAsync(key, values);
    ...
    public static Task<decimal?> GeoDistAsync(string key, object member1, object member2, GeoUnit unit = GeoUnit.m) =>
        Instance.GeoDistAsync(key, member1, member2, unit);
    ...
    public static Task<(decimal longitude, decimal latitude)?[]> GeoPosAsync(string key, object[] members) =>
        Instance.GeoPosAsync(key, members);
    ...
    /// <returns></returns>
    public static Task<string[]> GeoRadiusAsync(string key, decimal longitude, decimal latitude, decimal radius,
    ...
    /// <param name="sorting">排序</param>
    /// <returns></returns>
    public static Task<T[]> GeoRadiusAsync<T>(string key, decimal longitude, decimal latitude, decimal radius,
        GeoUnit unit = GeoUnit.m, long? count = null, GeoOrderBy? sorting = null) =>
    ...
    /// <param name="sorting">排序</param>
    /// <returns></returns>
    public static Task<(string member, decimal dist)[]> GeoRadiusWithDistAsync(string key, decimal longitude, decimal latitude,
    ...
    /// <param name="sorting">排序</param>
    /// <returns></returns>
    public static Task<(T member, decimal dist)[]> GeoRadiusWithDistAsync<T>(string key, decimal longitude, decimal latitude,
        decimal radius, GeoUnit unit = GeoUnit.m, long? count = null, GeoOrderBy? sorting = null) =>
    ...
    /// <param name="sorting">排序</param>
    /// <returns></returns>
    public static Task<(string member, decimal dist, decimal longitude, decimal latitude)[]> GeoRadiusWithDistAndCoordAsync(
    ...
    /// <param name="sorting">排序</param>
    /// <returns></returns>
    public static Task<(T member, decimal dist, decimal longitude, decimal latitude)[]> GeoRadiusWithDistAndCoordAsync<T>(
        string key, decimal longitude, decimal latitude, decimal radius, GeoUnit unit = GeoUnit.m, long? count = null,
        GeoOrderBy? sorting = null) =>
    ...
    /// <param name="sorting">排序</param>
    /// <returns></returns>
    public static Task<string[]> GeoRadiusByMemberAsync(string key, object member, decimal radius, GeoUnit unit = GeoUnit.m,
    ...
    /// <param name="sorting">排序</param>
    /// <returns></returns>
    public static Task<T[]> GeoRadiusByMemberAsync<T>(string key, object member, decimal radius, GeoUnit unit = GeoUnit.m,
        long? count = null, GeoOrderBy? sorting = null) =>
    ...
    /// <param name="sorting">排序</param>
    /// <returns></returns>
    public static Task<(string member, decimal dist)[]> GeoRadiusByMemberWithDistAsync(string key, object member, decimal radius,
        GeoUnit unit = GeoUnit.m, long? count = null, GeoOrderBy? sorting = null) =>
    ...
    /// <param name="sorting">排序</param>
    /// <returns></returns>
    public static Task<(T member, decimal dist)[]> GeoRadiusByMemberWithDistAsync<T>(string key, object member, decimal radius,
        GeoUnit unit = GeoUnit.m, long? count = null, GeoOrderBy? sorting = null) =>
    ...
    /// <param name="sorting">排序</param>
    /// <returns></returns>
    public static Task<(string member, decimal dist, decimal longitude, decimal latitude)[]>
    ...
    /// <param name="sorting">排序</param>
    /// <returns></returns>
    public static Task<(T member, decimal dist, decimal longitude, decimal latitude)[]> GeoRadiusByMemberWithDistAndCoordAsync<T>(
