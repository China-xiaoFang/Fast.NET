...
/// <summary>
/// Fast.NET 下的 <see cref="HttpDeleteAttribute"/> Identifies an action that supports the HTTP DELETE method.
/// </summary>
...
public class HttpDeleteAttribute : HttpMethodAttribute
{
    ...
    public HttpDeleteAttribute(string template, params string[] tags) : base(_supportedMethods, template)
    {
        if (template == null)
        {
