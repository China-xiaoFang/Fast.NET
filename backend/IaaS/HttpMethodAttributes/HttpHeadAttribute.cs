...
/// <summary>
/// Fast.NET 下的 <see cref="HttpHeadAttribute"/> Identifies an action that supports the HTTP HEAD method.
/// </summary>
...
public class HttpHeadAttribute : HttpMethodAttribute
{
    ...
    public HttpHeadAttribute(string template, params string[] tags) : base(_supportedMethods, template)
    {
        if (template == null)
        {
