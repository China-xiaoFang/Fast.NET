...
/// <summary>
/// Fast.NET 下的 <see cref="HttpPatchAttribute"/> Identifies an action that supports the HTTP PATCH method.
/// </summary>
...
public class HttpPatchAttribute : HttpMethodAttribute
{
    ...
    public HttpPatchAttribute(string template, params string[] tags) : base(_supportedMethods, template)
    {
        if (template == null)
        {
